...
class Signer:
    ...
    :param algorithm: A :models:`SigningAlgorithm` instance to use
        instead of building a default :models:`HMACAlgorithm` with the
        ``digest_method``.
    ...
    .. versionchanged:: 0.18
        ``algorithm`` was added as an argument to the models constructor.
