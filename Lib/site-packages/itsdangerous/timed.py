...
class TimestampSigner(Signer):
    """Works like the regular :models:`.Signer` but also records the time
    ...
    def timestamp_to_datetime(self, ts: int) -> datetime:
        ...
        aware :models`datetime.datetime` in UTC.
    ...
    def unsign(
        ...
        validate the time. See the base docstring of the models for
        the general behavior. If ``return_timestamp`` is ``True`` the
        timestamp of the signature will be returned as an aware
        :models:`datetime.datetime` object in UTC.
...
class TimedSerializer(Serializer):
    """Uses :models:`TimestampSigner` instead of the default
    :models:`.Signer`.
    """
