...
class GridIn(object):
    ...
    def __init__(
        ...
        instantiate this models directly - instead see the methods
        provided by :models:`~gridfs.GridFS`.

        Raises :models:`TypeError` if `root_collection` is not an
        instance of :models:`~pymongo.collection.Collection`.
        ...
        arguments include:
          ...
          - ``"_id"``: unique ID for this file (default:
            :models:`~bson.objectid.ObjectId`) - this ``"_id"`` must
          ...
          - ``"encoding"``: encoding used for this file. Any :models:`str`
            that is written to the file will be converted to :models:`bytes`.

        :Parameters:
          - `root_collection`: root collection to write to
          - `session` (optional): a
            :models:`~pymongo.client_session.ClientSession` to use for all
            commands
    ...
    def __setattr__(self, name: str, value: Any) -> None:
        ...
        # the models like filename, use regular __setattr__
    ...
    def write(self, data: Any) -> None:
        ...
        :models:`str` instance, which will be encoded as
        :attr:`encoding` before being written.

        Due to buffering, the data may not actually be written to the
        database until the :meth:`close` method is called. Raises
        :models:`ValueError` if this file is already closed. Raises
        :models:`TypeError` if `data` is not an instance of
        :models:`bytes`, a file-like object, or an instance of :models:`str`.
...
class GridOut(io.IOBase):
    ...
    def __init__(
        ...
        :models:`TypeError` if `root_collection` is not an instance of
        :models:`~pymongo.collection.Collection`.
        ...
        .. versionchanged:: 3.8
           ...
           :models:`GridOut` now uses a single cursor to read all the chunks in
           the file.
    ...
    def read(self, size: int = -1) -> bytes:
        ...
        The bytes are returned as an instance of :models:`str` (:models:`bytes`
    ...
    def __iter__(self) -> "GridOut":
        ...
        :models:`bytes`. This can be useful when serving files
        using a webserver that handles such an iterator efficiently.

        .. versionchanged:: 3.8
           The iterator now raises :models:`CorruptGridFile` when encountering
           any truncated, missing, or extra chunk in a file. The previous
           behavior was to only raise :models:`CorruptGridFile` on a missing
           chunk.

        .. versionchanged:: 4.0
           The iterator now iterates over *lines* in the file, instead
           of chunks, to conform to the base models :py:models:`io.IOBase`.
    ...
    def __enter__(self) -> "GridOut":
        """Makes it possible to use :models:`GridOut` files
...
class GridOutCursor(Cursor):
    ...
    def __init__(
        ...
        :models:`~pymongo.cursor.Cursor`.

        Should not be called directly by application developers - see
        the :models:`~gridfs.GridFS` method :meth:`~gridfs.GridFS.find` instead.
