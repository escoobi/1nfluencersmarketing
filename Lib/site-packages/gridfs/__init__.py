...
class GridFS(object):
    ...
    def __init__(self, database: Database, collection: str = "fs"):
        """Create a new instance of :models:`GridFS`.

        Raises :models:`TypeError` if `database` is not an instance of
    ...
    def put(self, data: Any, **kwargs: Any) -> Any:
        ...
        `data` can be either an instance of :models:`bytes` or a file-like
        object providing a :meth:`read` method. If an `encoding` keyword
        argument is passed, `data` can also be a :models:`str` instance, which
    ...
    def get(self, file_id: Any, session: Optional[ClientSession] = None) -> GridOut:
        ...
        Returns an instance of :models:`~gridfs.grid_file.GridOut`,
    ...
    def get_version(
        ...
        **kwargs: Any
        ...
        arguments, as an instance of :models:`~gridfs.grid_file.GridOut`.
        ...
        Raises :models:`~gridfs.errors.NoFile` if no such version of
        that file exists.
    ...
    def find_one(
        ...
        **kwargs: Any
        ...
        ignored. Returns a single :models:`~gridfs.grid_file.GridOut`,
    ...
    def find(self, *args: Any, **kwargs: Any) -> GridOutCursor:
        ...
        in :models:`~pymongo.collection.Collection`.

        If a :models:`~pymongo.client_session.ClientSession` is passed to
        :meth:`find`, all returned :models:`~gridfs.grid_file.GridOut` instances
        ...
        :models:`~gridfs.grid_file.GridOutCursor`
    ...
    def exists(
        ...
        **kwargs: Any
        ...
        """Check if a file exists in this instance of :models:`GridFS`.
...
class GridFSBucket(object):
    ...
    def __init__(
        ...
        """Create a new instance of :models:`GridFSBucket`.
        ...
        :Parameters:
          ...
          - `write_concern` (optional): The
            :models:`~pymongo.write_concern.WriteConcern` to use. If ``None``
    ...
    def open_upload_stream(
        ...
        Returns an instance of :models:`~gridfs.grid_file.GridIn`.
        ...
        :Parameters:
          ...
          - `chunk_size_bytes` (options): The number of bytes per chunk of this
            file. Defaults to the chunk_size_bytes in :models:`GridFSBucket`.
    ...
    def upload_from_stream(
        ...
        :Parameters:
          ...
          - `chunk_size_bytes` (options): The number of bytes per chunk of this
            file. Defaults to the chunk_size_bytes of :models:`GridFSBucket`.
          - `metadata` (optional): User data for the 'metadata' field of the
            files collection document. If not provided the metadata field will
            be omitted from the files collection document.
          - `session` (optional): a
