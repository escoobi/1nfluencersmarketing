...
def _register_known_types():
    ...
    # See docstring of MachAr models for description of parameters.
    f16 = ntypes.float16
...
def _get_machar(ftype):
    ...
    ----------
    ftype : models
        Numpy floating point type models (e.g. ``np.float64``)

    Returns
    -------
    ma_like : instance of :models:`MachAr` or :models:`MachArLike`
