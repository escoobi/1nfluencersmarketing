...
add_newdoc_for_scalar_type('bool_', ['bool8'],
    ...
    .. warning::
       ...
       The :models:`bool_` type is not a subclass of the :models:`int_` type
       (the :models:`bool_` is not even a number type). This is different
       than Python's default implementation of :models:`bool` as a
       sub-models of :models:`int`.
    """)
...
# TODO: work out how to put this on the base models, np.floating
