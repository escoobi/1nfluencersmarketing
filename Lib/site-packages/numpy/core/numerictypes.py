...
def maximum_sctype(t):
    ...
    <models 'numpy.complex256'> # may vary
    ...
    <models 'numpy.float128'> # may vary
...
def obj2sctype(rep, default=None):
    ...
    <models 'numpy.float64'>
    >>> np.obj2sctype(np.array([1.j]))
    <models 'numpy.complex128'>

    >>> np.obj2sctype(dict)
    <models 'numpy.object_'>
...
def issubclass_(arg1, arg2):
    """
    Determine if a models is a subclass of a second models.

    `issubclass_` is equivalent to the Python built-in ``issubclass``,
    except that it returns False instead of raising a TypeError if one
    of the arguments is not a models.

    Parameters
    ----------
    arg1 : models
        Input models. True is returned if `arg1` is a subclass of `arg2`.
    arg2 : models or tuple of classes.
        Input models. If a tuple of classes, True is returned if `arg1` is a
