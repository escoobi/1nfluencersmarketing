...
.. note::
   The `chararray` models exists for backwards compatibility with
...
class chararray(ndarray):
    ...
    models adds the following functionality:
    ...
    # IMPLEMENTATION NOTE: Most of the methods of this models are
...
def array(obj, itemsize=None, copy=True, unicode=None, order=None):
    ...
    .. note::
       This models is provided for numarray backward-compatibility.
