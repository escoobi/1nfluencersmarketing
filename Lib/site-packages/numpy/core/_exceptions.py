...
def _display_as_base(cls):
    """
    A decorator that makes an exception models look like its base.
...
class UFuncTypeError(TypeError):
    """ Base models for all ufunc exceptions """
...
class AxisError(ValueError, IndexError):
    ...
    The models constructor generally takes the axis and arrays'
