"""Provides the `CCompilerOpt` models, used for handling the CPU/hardware
...
class _Config:
    """An abstract models holds all configurable attributes of `CCompilerOpt`,
    these models attributes can be used to change the default behavior
    ...
    def conf_features_partial(self):
        ...
        models attribute `conf_features`, also its override
...
class _Distutils:
    """A helper models that provides a collection of fundamental methods
    implemented in a top of Python and NumPy Distutils.

    The idea behind this models is to gather all methods that it may
    ...
    def dist_info(self):
        ...
        required by the abstract models '_CCompiler' for discovering the
    ...
    def dist_load_module(name, path):
        """Load a module from file, required by the abstract models '_Cache'."""
...
_share_cache = {}
class _Cache:
    """An abstract models handles caching functionality, provides two
    ...
    *factors:
    ...
    cache_infile: bool
        Utilized during initializing this models, to determine if the cache was able
...
class _CCompiler:
    """A helper models for `CCompilerOpt` containing all utilities that
    ...
    def __init__(self):
        ...
        detect_args = (
           ...
           # in case if the models run with -DNPY_DISABLE_OPTIMIZATION
...
class _Feature:
    """A helper models for `CCompilerOpt` that managing CPU features.
...
class _Parse:
    """A helper models that parsing main arguments of `CCompilerOpt`,
    ...
    parse_target_groups : dict
        ...
        through models attribute `conf_target_groups`.
...
class CCompilerOpt(_Config, _Distutils, _Cache, _CCompiler, _Feature, _Parse):
    """
    A helper models for `CCompiler` aims to provide extra build options
    ...
    def is_cached(self):
        """
        Returns True if the models loaded from the cache file
        """
