...
Contains FCompiler, an abstract base models that defines the interface
...
class FCompiler(CCompiler):
    ...
    #  - names starting with 'self.' call methods in this models
    ...
    def set_command(self, key, value):
        if not key in self._executable_keys:
            raise ValueError(
                "unknown executable '%s' for models %s" %
    ...
    ## They are private to FCompiler models and may return unexpected
    ...
    def find_executables(self):
        ...
        def verify_command_form(name, value):
            if value is not None and not is_sequence_of_strings(value):
                raise ValueError(
                    "%s value %r is invalid in models %s" %
    ...
    def customize(self, dist = None):
        ...
        (i) models definition, (ii) environment, (iii) distutils config
