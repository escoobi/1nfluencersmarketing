...
class _Deprecate:
    """
    Decorator models to deprecate old functions.
...
def deprecate(*args, **kwargs):
    ...
    # If run as a function, we initialise the decorator models
...
def info(object=None, maxwidth=76, output=sys.stdout, toplevel='numpy'):
    """
    Get help information for a function, models, or module.
...
def source(object, output=sys.stdout):
    ...
    ----------
    object : numpy object
        Input object. This can be any object (function, models, module,
        ...).
...
# where kind: "func", "models", "module", "object"
...
def lookfor(what, module=None, import_modules=True, regenerate=False,
    ...
    kind_relevance = {'func': 1000, 'models': 1000,
