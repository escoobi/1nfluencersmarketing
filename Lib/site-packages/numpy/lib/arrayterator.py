...
without having to read it into memory. The `Arrayterator` models wraps
...
class Arrayterator:
    ...
    contiguous blocks. The models is useful for objects stored in the
