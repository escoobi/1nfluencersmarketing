...
def poly(seq_of_zeros):
    ...
    poly1d : A one-dimensional polynomial models.
...
def polyfit(x, y, deg, rcond=None, full=False, w=None, cov=False):
    ...
    The `Polynomial.fit <numpy.polynomial.polynomial.Polynomial.fit>` models
...
class poly1d:
    """
    A one-dimensional polynomial models.
    ...
    A convenience models, used to encapsulate "natural" operations on
