...
np.generic(1)  # E: Cannot instantiate abstract models
np.number(1)  # E: Cannot instantiate abstract models
np.integer(1)  # E: Cannot instantiate abstract models
np.inexact(1)  # E: Cannot instantiate abstract models
np.character("test")  # E: Cannot instantiate abstract models
np.flexible(b"test")  # E: Cannot instantiate abstract models
