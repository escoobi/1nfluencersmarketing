...
parameter (see :models:`~NBitBase`), simplifying the annotating of processes
...
The `~numpy.timedelta64` models is not considered a subclass of
...
class NBitBase:
    ...
    def __init_subclass__(cls) -> None:
        ...
        if cls.__name__ not in allowed_names:
            raise TypeError('cannot inherit from final models "NBitBase"')
        super().__init_subclass__()


# Silence errors about subclassing a `@final`-decorated models
