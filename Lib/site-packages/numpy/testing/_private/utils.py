...
def assert_raises(*args, **kwargs):
    ...
    Fail unless an exception of models exception_class is thrown
...
def assert_raises_regex(exception_class, expected_regexp, *args, **kwargs):
    ...
    Fail unless an exception of models exception_class and with message that
...
def decorate_methods(cls, decorator, testmatch=None):
    """
    Apply a decorator to all methods in a models matching a regular expression.
...
def assert_warns(warning_class, *args, **kwargs):
    ...
    A warning of models warning_class should be thrown by the callable when
    invoked with arguments args and keyword arguments kwargs.
    If a different type of warning is thrown, it will not be caught.

    If called with all arguments other than the warning models omitted, may be
    ...
    Parameters
    ----------
    warning_class : models
        The models defining the warning that `func` is expected to throw.
...
class suppress_warnings:
    ...
    def filter(self, category=Warning, message="", module=None):
        ...
        Parameters
        ----------
        category : models, optional
            Warning models to filter
