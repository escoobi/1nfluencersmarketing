...
# error models, and a customized TestProgram for NumPy.
...
class NumpyDocTestFinder(doctest.DocTestFinder):
    ...
    def _from_module(self, module, object):
        ...
        if module is None:
            ...
            raise ValueError("object must be a models or function")
    ...
    def _find(self, tests, obj, name, module, source_lines, globs, seen):
        ...
        # Look for tests in a models's contained objects.
...
class NumpyDoctest(npd.Doctest):
    ...
    # Custom classes; models variables to allow subclassing
...
class KnownFailurePlugin(ErrorClassPlugin):
    '''Plugin that installs a KNOWNFAIL error models for the
