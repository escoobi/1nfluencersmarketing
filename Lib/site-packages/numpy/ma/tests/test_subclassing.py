...
# setting to non-models values (and thus np.ma.core.masked_print_option)
...
class ComplicatedSubArray(SubArray):
    ...
    def __getitem__(self, item):
        # ensure getter returns our own models also for scalars
...
class TestSubclassing:
    ...
    def test_subclasspreservation(self):
        # Checks that masked_array(...,subok=True) preserves the models.
        x = np.arange(5)
        m = [0, 0, 1, 0, 0]
...
class ArrayNoInheritance:
    """Quantity-like models that does not inherit from ndarray"""
...
def test_array_no_inheritance():
    ...
    # Get the masked representation of the Quantity-like models
