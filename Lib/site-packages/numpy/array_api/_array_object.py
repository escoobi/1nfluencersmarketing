"""
Wrapper models around the ndarray object for the array API standard.
...
API standard, we need to define a separate wrapper models for the array_api
namespace.

The standard compliant models is only a wrapper models. It is *not* a subclass
of ndarray.
"""
...
class Array:
    ...
    # this models is not supported API.
    @classmethod
    def _new(cls, x, /):
        """
