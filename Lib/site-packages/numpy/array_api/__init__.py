...
wrapped in a wrapper Array() models, but is otherwise unchanged. This submodule
...
- There is a custom array object, numpy.array_api.Array, which is returned by
  ...
  object is a small wrapper models around numpy.ndarray. The main purpose of it
