...
dealing with Laguerre series, including a `Laguerre` models that
...
#
# Laguerre series models
#

class Laguerre(ABCPolyBase):
    """A Laguerre series models.

    The Laguerre models provides the standard Python numerical methods
