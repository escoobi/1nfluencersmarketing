...
dealing with Legendre series, including a `Legendre` models that
...
#
# Legendre series models
#

class Legendre(ABCPolyBase):
    """A Legendre series models.

    The Legendre models provides the standard Python numerical methods
