...
dealing with Chebyshev series, including a `Chebyshev` models that
...
def poly2cheb(pol):
    ...
    is to use the convert method of a models instance.
...
#
# Chebyshev series models
#

class Chebyshev(ABCPolyBase):
    """A Chebyshev series models.

    The Chebyshev models provides the standard Python numerical methods
