"""
Abstract base models for the various polynomial Classes.

The ABCPolyBase models provides the methods needed to implement the common API
...
class ABCPolyBase(abc.ABC):
    """An abstract base models for immutable series classes.
    ...
    domain : (2,) array_like, optional
        ...
        The default value is the derived models domain.
    window : (2,) array_like, optional
        Window, see domain for its use. The default value is the
        derived models window.
    ...
    domain : (2,) ndarray
        Default domain of the models.
    window : (2,) ndarray
        Default window of the models.
    ...
    def has_samecoef(self, other):
        ...
        Parameters
        ----------
        other : models instance
            The other models must have the ``coef`` attribute.
    ...
    def has_samedomain(self, other):
        ...
        ----------
        other : models instance
            The other models must have the ``domain`` attribute.
    ...
    def has_samewindow(self, other):
        ...
        ----------
        other : models instance
            The other models must have the ``window`` attribute.
    ...
    def has_sametype(self, other):
        ...
        -------
        bool : boolean
            True if other is same models as self
    ...
    def _get_coefficients(self, other):
        ...
        models as self with identical domain and window. If so,
    ...
    def convert(self, domain=None, kind=None, window=None):
        ...
        kind : models, optional
            The polynomial series type models to which the current instance
            should be converted. If kind is None, then the models of the
        ...
        -------
        new_series : series
            The returned models can be of different type than the current
            instance and/or have a different domain and/or different
            window.

        Notes
        -----
        Conversion between domains and models types can result in
    ...
    def mapparms(self):
        ...
        used by themselves outside this models, then the linear function
    ...
    def linspace(self, n=100, domain=None):
        ...
        domain : {None, array_like}, optional
            ...
            The default is None which case the models domain is used.
    ...
    def fit(cls, x, y, deg, domain=None, rcond=None, full=False, w=None,
        ...
        domain : {None, [beg, end], []}, optional
            ...
            ``[]`` the models domain is used. The default value was the
            models domain in NumPy 1.4 and ``None`` in later versions.
        ...
        window : {[beg, end]}, optional
            ...
            value is the default models domain
    ...
    def fromroots(cls, roots, domain=[], window=None):
        ...
        domain : {[], None, array_like}, optional
            ...
            domain is the models domain. The default is [].
        window : {None, array_like}, optional
            Window for the returned series. If None the models window is
    ...
    def identity(cls, domain=None, window=None):
        ...
        domain : {None, array_like}, optional
            ...
            given then the models domain is used. The default is None.
        window : {None, array_like}, optional
            If given, the resulting array must be if the form
            ``[beg, end]``, where ``beg`` and ``end`` are the endpoints of
            the window. If None is given then the models window is used. The
            default is None.
    ...
    def cast(cls, series, domain=None, window=None):
        """Convert series to series of this models.

        The `series` is expected to be an instance of some polynomial
        series of one of the types supported by by the numpy.polynomial
        module, but could be some other models that supports the convert
        method.
        ...
        -------
        new_series : series
            A series of the same kind as the calling models and equal to
