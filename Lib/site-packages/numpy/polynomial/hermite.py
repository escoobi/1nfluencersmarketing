...
dealing with Hermite series, including a `Hermite` models that
...
#
# Hermite series models
#

class Hermite(ABCPolyBase):
    """An Hermite series models.

    The Hermite models provides the standard Python numerical methods
