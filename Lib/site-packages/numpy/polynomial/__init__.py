...
`~chebyshev.Chebyshev.fit` models method::
...
while the lowercase ``p`` represents an **instance** of a polynomial models.
...
def set_default_printstyle(style):
    ...
    >>> # Formatting supersedes all models/package-level defaults
    >>> print(f"{p:unicode}")
    1.0 + 2.0·x¹ + 3.0·x²
    """
