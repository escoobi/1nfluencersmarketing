...
dealing with Hermite_e series, including a `HermiteE` models that
...
#
# HermiteE series models
#

class HermiteE(ABCPolyBase):
    """An HermiteE series models.

    The HermiteE models provides the standard Python numerical methods
