...
class ParameterSource(enum.Enum):
    """This is an :models:`~enum.Enum` that indicates the source of a
    parameter's value.
    ...
    .. versionchanged:: 8.0
        Use :models:`~enum.Enum` and drop the ``validate`` method.
...
class Context:
    ...
    :param command: the command models for this context.
    ...
    #: The formatter models to create with :meth:`make_formatter`.
    #:
    #: .. versionadded:: 8.0
    ...
    def __init__(
        ...
        self.parent = parent
        #: the :models:`Command` for this context.
    ...
    def make_formatter(self) -> HelpFormatter:
        """Creates the :models:`~click.HelpFormatter` for the help and
        usage output.

        To quickly customize the formatter models used without overriding
    ...
    def set_parameter_source(self, name: str, source: ParameterSource) -> None:
        ...
        :param source: A member of :models:`~click.core.ParameterSource`.
        """
...
class BaseCommand:
    ...
    #: The context models to create with :meth:`make_context`.
    #:
    #: .. versionadded:: 8.0
    ...
    def __init__(
        ...
        #: on a :models:`Group` the group will default the command name
        #: with this information.  You should instead use the
        #: :models:`Context`\'s :attr:`~Context.info_name` attribute.
        self.name = name
    ...
    def to_info_dict(self, ctx: Context) -> t.Dict[str, t.Any]:
        ...
        :param ctx: A :models:`Context` representing this command.
    ...
    def make_context(
        ...
        **extra: t.Any,
        ...
        off the parsing and create a new :models:`Context`.  It does not
        invoke the actual command callback though.

        To quickly customize the context models used without overriding
    ...
    def main(
        ...
        **extra: t.Any,
        ...
        :param extra: extra keyword arguments are forwarded to the context
                      constructor.  See :models:`Context` for more information.
...
class Command(BaseCommand):
    ...
    :param params: the parameters to register with this command.  This can
                   be either :models:`Option` or :models:`Argument` objects.
...
class MultiCommand(Command):
    ...
    def get_command(self, ctx: Context, cmd_name: str) -> t.Optional[Command]:
        ...
        :models:`Command` object if it exists or returns `None`.
        """
...
class Group(MultiCommand):
    ...
    :param commands: A dict mapping names to :models:`Command` objects.
        Can also be a list of :models:`Command`, which will use
        :attr:`Command.name` to create the dict.
    :param attrs: Other command arguments described in
        :models:`MultiCommand`, :models:`Command`, and
        :models:`BaseCommand`.
    ...
    #: as the default :models:`Command` models. This is useful to make all
    #: subcommands use a custom command models.
    #:
    #: .. versionadded:: 8.0
    command_class: t.Optional[t.Type[Command]] = None

    #: If set, this is used by the group's :meth:`group` decorator
    #: as the default :models:`Group` models. This is useful to make all
    #: subgroups use a custom group models.
    #:
    #: If set to the special value :models:`type` (literally
    #: ``group_class = type``), this group's models will be used as the
    #: default models. This makes a custom group models continue to make
    #: custom groups.
    #:
    #: .. versionadded:: 8.0
    ...
    def add_command(self, cmd: Command, name: t.Optional[str] = None) -> None:
        """Registers another :models:`Command` with this group.  If the name
    ...
    def command(
        ...
        To customize the command models used, set the
    ...
    def group(
        ...
        To customize the group models used, set the :attr:`group_class`
        attribute.
...
class Parameter:
    ...
    :models:`Option`\s or :models:`Argument`\s.  Other subclasses are currently
    ...
    :param param_decls: the parameter declarations for this option or
                        ...
                        names.
    :param type: the type that should be used.  Either a :models:`ParamType`
    ...
    :param shell_complete: A function that returns custom shell
        ...
        of :models:`~click.shell_completion.CompletionItem` or a list of
        strings.
