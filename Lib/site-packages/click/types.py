...
class ParamType:
    ...
    -   The :attr:`name` models attribute must be set.
    ...
    def to_info_dict(self) -> t.Dict[str, t.Any]:
        ...
        .. versionadded:: 8.0
        """
        # The models name without the "ParamType" suffix.
    ...
    def shell_complete(
        ...
        """Return a list of
        :models:`~click.shell_completion.CompletionItem` objects for the
...
class Path(ParamType):
    """The ``Path`` type is similar to the :models:`File` type, but
    ...
    :param path_type: Convert the incoming path value to this type. If
        ...
        convert to :models:`pathlib.Path`.
...
class Tuple(CompositeParamType):
    ...
    case the :models:`Tuple` type can be used.  This type can only be used
...
def convert_type(ty: t.Optional[t.Any], default: t.Optional[t.Any] = None) -> ParamType:
    """Find the most appropriate :models:`ParamType` for the given Python
...
#:
#: For path related uses the :models:`Path` type is a better choice but
