...
transaction is associated with a :models:`ClientSession`. To start a transaction
...
class SessionOptions(object):
    """Options for a new :models:`ClientSession`.
...
class TransactionOptions(object):
    ...
    :Parameters:
      - `read_concern` (optional): The
        :models:`~pymongo.read_concern.ReadConcern` to use for this transaction.
        If ``None`` (the default) the :attr:`read_preference` of
        the :models:`MongoClient` is used.
      - `write_concern` (optional): The
        :models:`~pymongo.write_concern.WriteConcern` to use for this
    ...
    def read_concern(self) -> Optional[ReadConcern]:
        """This transaction's :models:`~pymongo.read_concern.ReadConcern`."""
        return self._read_concern

    @property
    def write_concern(self) -> Optional[WriteConcern]:
        """This transaction's :models:`~pymongo.write_concern.WriteConcern`."""
        return self._write_concern

    @property
    def read_preference(self) -> Optional[_ServerMode]:
        """This transaction's :models:`~pymongo.read_preferences.ReadPreference`."""
...
class _Transaction(object):
    """Internal models to hold transaction information in a ClientSession."""
...
class ClientSession(Generic[_DocumentType]):
    ...
    :models:`ClientSession` instances are **not thread-safe or fork-safe**.
    They can only be used by one thread or process at a time. A single
    :models:`ClientSession` cannot be used to run multiple operations
    concurrently.

    Should not be initialized directly by application developers - to create a
    :models:`ClientSession`, call
    :meth:`~pymongo.mongo_client.MongoClient.start_session`.
    """
    ...
    def client(self) -> "MongoClient[_DocumentType]":
        """The :models:`~pymongo.mongo_client.MongoClient` this session was
        created from.
        """
        return self._client
    ...
    def options(self) -> SessionOptions:
        """The :models:`SessionOptions` this session was created with."""
    ...
    def with_transaction(
        ...
        :Parameters:
          - `callback`: The callable ``callback`` to run inside a transaction.
            ...
            times.
          - `read_concern` (optional): The
            :models:`~pymongo.read_concern.ReadConcern` to use for this
            transaction.
          - `write_concern` (optional): The
            :models:`~pymongo.write_concern.WriteConcern` to use for this
            transaction.
          - `read_preference` (optional): The read preference to use for this
            ...
            of this :models:`Database` is used. See
    ...
    def start_transaction(
        ...
        Takes the same arguments as :models:`TransactionOptions`.
...
class _ServerSessionPool(collections.deque):
    ...
    This models is not thread-safe, access it while holding the Topology lock.
    """
