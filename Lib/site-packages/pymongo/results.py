...
class _WriteResult(object):
    """Base models for write result classes."""
    ...
    def acknowledged(self) -> bool:
        ...
        .. note::
          ...
          attibutes of this models will raise
          :models:`~pymongo.errors.InvalidOperation` when accessed. Values for
