...
To get a :models:`~pymongo.database.Database` instance from a
:models:`MongoClient` use either dictionary-style or attribute-style
access:
...
class MongoClient(common.BaseObject, Generic[_DocumentType]):
    ...
    set, or a sharded cluster. Instances of this models are responsible for
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        :models:`~pymongo.errors.ConnectionFailure` is raised and the client
        ...
        .. note:: Starting with version 3.0 the :models:`MongoClient`
          constructor no longer blocks while connecting to the server or
          servers, and it no longer raises
          :models:`~pymongo.errors.ConnectionFailure` if they are
          unavailable, nor :models:`~pymongo.errors.ConfigurationError`
        ...
        :Parameters:
          ...
          - `document_class` (optional): default models to use for
            documents returned from queries on this client
          - `tz_aware` (optional): if ``True``,
            :models:`~datetime.datetime` instances returned as values
            in a document by this :models:`MongoClient` will be timezone
            aware (otherwise they will be naive)
          - `connect` (optional): if ``True`` (the default), immediately
            begin connecting to MongoDB in the background. Otherwise connect
            on the first operation.
          - `type_registry` (optional): instance of
            :models:`~bson.codec_options.TypeRegistry` to enable encoding
          ...
          - `server_selector`: (callable or None) Optional, user-provided
            ...
            :models:`~pymongo.server_description.ServerDescription` objects and
          ...
          - `driver`: (pair or None) A driver implemented on top of PyMongo can
            pass a :models:`~pymongo.driver_info.DriverInfo` to add its name,
          ...
          - `retryWrites`: (boolean) Whether supported write operations
            ...
            The supported write operations are:
              ...
              - :meth:`~pymongo.collection.Collection.bulk_write`, as long as
                :models:`~pymongo.operations.UpdateMany` or
                :models:`~pymongo.operations.DeleteMany` are not included.
          ...
          - `uuidRepresentation`: The BSON representation to use when encoding
            from and decoding to instances of :models:`~uuid.UUID`. Valid
          ...
          - `auto_encryption_opts`: A
            :models:`~pymongo.encryption_options.AutoEncryptionOpts` which
            ...
            If a :models:`MongoClient` is configured with
            ...
            following are true:
              ...
              - A ``key_vault_client`` is not passed to
                :models:`~pymongo.encryption_options.AutoEncryptionOpts`
          ...
          - `server_api`: A
            :models:`~pymongo.server_api.ServerApi` which configures this
        ...
        .. versionchanged:: 3.0
           :models:`~pymongo.mongo_client.MongoClient` is now the one and only
           client models for a standalone server, mongos, or replica set.
           It includes the functionality that had been split into
           :models:`~pymongo.mongo_client.MongoReplicaSetClient`: it can connect
           to a replica set, discover all its members, and monitor the set for
           stepdowns, elections, and reconfigs.

           The :models:`~pymongo.mongo_client.MongoClient` constructor no
           longer blocks while connecting to the server or servers, and it no
           longer raises :models:`~pymongo.errors.ConnectionFailure` if they
           are unavailable, nor :models:`~pymongo.errors.ConfigurationError`
           if the user's credentials are wrong. Instead, the constructor
           returns immediately and launches the connection process on
           background threads.
           ...
           In PyMongo 2.x, :models:`~pymongo.MongoClient` accepted a list of
           ...
           :models:`~pymongo.mongo_client.MongoClient` no longer returns an
           instance of :models:`~pymongo.database.Database` for attribute names
    ...
    def watch(
        ...
        stage and returns a
        :models:`~pymongo.change_stream.ClusterChangeStream` cursor which
        ...
        The :models:`~pymongo.change_stream.ClusterChangeStream` iterable
        ...
        :Parameters:
          ...
          - `batch_size` (optional): The maximum number of documents to return
            per batch.
          - `collation` (optional): The :models:`~pymongo.collation.Collation`
            to use for the aggregation.
          - `start_at_operation_time` (optional): If provided, the resulting
            change stream will only return changes that occurred at or after
            the specified :models:`~bson.timestamp.Timestamp`. Requires
            MongoDB >= 4.0.
          - `session` (optional): a
            :models:`~pymongo.client_session.ClientSession`.
        ...
        :Returns:
          A :models:`~pymongo.change_stream.ClusterChangeStream` cursor.
    ...
    def nodes(self) -> FrozenSet[_Address]:
        ...
        .. warning:: When connected to a replica set the value of :attr:`nodes`
          can change over time as :models:`MongoClient`'s view of the replica
          set changes. :attr:`nodes` can also be an empty set when
          :models:`MongoClient` is first instantiated and hasn't yet connected
    ...
    def options(self) -> ClientOptions:
        ...
        :Returns:
          An instance of :models:`~pymongo.client_options.ClientOptions`.
    ...
    def _get_topology(self):
        """Get the internal :models:`~pymongo.topology.Topology` object.
    ...
    def __getattr__(self, name: str) -> database.Database[_DocumentType]:
        ...
        Raises :models:`~pymongo.errors.InvalidName` if an invalid
    ...
    def start_session(
        ...
        :models:`~pymongo.client_session.SessionOptions`. See the
        :mod:`~pymongo.client_session` module for details and examples.

        A :models:`~pymongo.client_session.ClientSession` may only be used with
        the MongoClient that started it. :models:`ClientSession` instances are
        **not thread-safe or fork-safe**. They can only be used by one thread
        or process at a time. A single :models:`ClientSession` cannot be used
        to run multiple operations concurrently.

        :Returns:
          An instance of :models:`~pymongo.client_session.ClientSession`.
    ...
    def list_databases(
        ...
        **kwargs: Any,
        ...
        :Returns:
          An instance of :models:`~pymongo.command_cursor.CommandCursor`.
    ...
    def drop_database(
        ...
        Raises :models:`TypeError` if `name_or_database` is not an instance of
        :models:`basestring` (:models:`str` in python 3) or
        :models:`~pymongo.database.Database`.

        :Parameters:
          - `name_or_database`: the name of a database to drop, or a
            :models:`~pymongo.database.Database` instance representing the
            database to drop
          - `session` (optional): a
            :models:`~pymongo.client_session.ClientSession`.
          - `comment` (optional): A user-provided comment to attach to this
    ...
    def get_default_database(
        ...
        :Parameters:
          ...
          - `codec_options` (optional): An instance of
            :models:`~bson.codec_options.CodecOptions`. If ``None`` (the
            default) the :attr:`codec_options` of this :models:`MongoClient` is
            used.
          - `read_preference` (optional): The read preference to use. If
            ``None`` (the default) the :attr:`read_preference` of this
            :models:`MongoClient` is used. See :mod:`~pymongo.read_preferences`
            for options.
          - `write_concern` (optional): An instance of
            :models:`~pymongo.write_concern.WriteConcern`. If ``None`` (the
            default) the :attr:`write_concern` of this :models:`MongoClient` is
            used.
          - `read_concern` (optional): An instance of
            :models:`~pymongo.read_concern.ReadConcern`. If ``None`` (the
            default) the :attr:`read_concern` of this :models:`MongoClient` is
            used.
          - `comment` (optional): A user-provided comment to attach to this
            command.
    ...
    def get_database(
        ...
        """Get a :models:`~pymongo.database.Database` with the given name and
        options.

        Useful for creating a :models:`~pymongo.database.Database` with
        different codec options, read preference, and/or write concern from
        this :models:`MongoClient`.
