...
"""Cursor models to iterate over Mongo query results."""
import copy
import threading
import warnings
...
class Cursor(Generic[_DocumentType]):
    ...
    def collection(self) -> "Collection[_DocumentType]":
        """The :models:`~pymongo.collection.Collection` that this
        :models:`Cursor` is iterating.
        """
    ...
    def limit(self, limit: int) -> "Cursor[_DocumentType]":
        ...
        :exc:`~pymongo.errors.InvalidOperation` if this :models:`Cursor`
    ...
    def batch_size(self, batch_size: int) -> "Cursor[_DocumentType]":
        ...
        :models:`Cursor` has already been used. The last `batch_size`
    ...
    def skip(self, skip: int) -> "Cursor[_DocumentType]":
        ...
        :exc:`~pymongo.errors.InvalidOperation` if this :models:`Cursor` has
    ...
    def max_time_ms(self, max_time_ms: Optional[int]) -> "Cursor[_DocumentType]":
        ...
        Raises :exc:`~pymongo.errors.InvalidOperation` if this :models:`Cursor`
    ...
    def max_await_time_ms(self, max_await_time_ms: Optional[int]) -> "Cursor[_DocumentType]":
        ...
        :models:`Cursor` has already been used.
    ...
    def __getitem__(self, index):
        ...
        .. warning:: A :models:`~Cursor` is not a Python :models:`list`. Each
        ...
        Raises :models:`~pymongo.errors.InvalidOperation` if this
        ...
        An :models:`IndexError` will be raised if the index is negative
        ...
        :models:`IndexError` when the slice has a step, a negative
    ...
    def sort(
        ...
        Raises :models:`~pymongo.errors.InvalidOperation` if this cursor has
    ...
    def distinct(self, key: str) -> List:
        ...
        :models:`~pymongo.collection.Collection` instance on which
    ...
    def hint(self, index: Optional[_Hint]) -> "Cursor[_DocumentType]":
        ...
        the query. Raises :models:`~pymongo.errors.OperationFailure` if the
        provided hint requires an index that does not exist on this collection,
        and raises :models:`~pymongo.errors.InvalidOperation` if this cursor has
        already been used.
    ...
    def where(self, code: Union[str, Code]) -> "Cursor[_DocumentType]":
        ...
        The `code` argument must be an instance of :models:`basestring`
        (:models:`str` in python 3) or :models:`~bson.code.Code`
        ...
        Raises :models:`TypeError` if `code` is not an instance of
        :models:`basestring` (:models:`str` in python 3). Raises
        :models:`~pymongo.errors.InvalidOperation` if this
        :models:`Cursor` has already been used. Only the last call to
        :meth:`where` applied to a :models:`Cursor` has any effect.

        .. note:: MongoDB 4.4 drops support for :models:`~bson.code.Code`
    ...
    def collation(self, collation: Optional[_CollationIn]) -> "Cursor[_DocumentType]":
        """Adds a :models:`~pymongo.collation.Collation` to this query.

        Raises :exc:`TypeError` if `collation` is not an instance of
        :models:`~pymongo.collation.Collation` or a ``dict``. Raises
        :exc:`~pymongo.errors.InvalidOperation` if this :models:`Cursor` has
        already been used. Only the last collation applied to this cursor has
        any effect.

        :Parameters:
          - `collation`: An instance of :models:`~pymongo.collation.Collation`.
        """
        self.__check_okay_to_chain()
        self.__collation = validate_collation_or_none(collation)
        return self
    ...
    def session(self) -> Optional["ClientSession"]:
        """The cursor's :models:`~pymongo.client_session.ClientSession`, or None.
