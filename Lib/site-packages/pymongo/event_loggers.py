...
class CommandLogger(monitoring.CommandListener):
    ...
    Listens for :models:`~pymongo.monitoring.CommandStartedEvent`,
    :models:`~pymongo.monitoring.CommandSucceededEvent` and
    :models:`~pymongo.monitoring.CommandFailedEvent` events and
...
class ServerLogger(monitoring.ServerListener):
    ...
    Listens for :models:`~pymongo.monitoring.ServerOpeningEvent`,
    :models:`~pymongo.monitoring.ServerDescriptionChangedEvent`,
    and :models:`~pymongo.monitoring.ServerClosedEvent`
...
class HeartbeatLogger(monitoring.ServerHeartbeatListener):
    ...
    Listens for :models:`~pymongo.monitoring.ServerHeartbeatStartedEvent`,
    :models:`~pymongo.monitoring.ServerHeartbeatSucceededEvent`,
    and :models:`~pymongo.monitoring.ServerHeartbeatFailedEvent`
    events and logs them at the `INFO` severity level using :mod:`logging`.
...
class TopologyLogger(monitoring.TopologyListener):
    ...
    Listens for :models:`~pymongo.monitoring.TopologyOpenedEvent`,
    :models:`~pymongo.monitoring.TopologyDescriptionChangedEvent`,
    and :models:`~pymongo.monitoring.TopologyClosedEvent`
    events and logs them at the `INFO` severity level using :mod:`logging`.
...
class ConnectionPoolLogger(monitoring.ConnectionPoolListener):
    ...
    Listens for :models:`~pymongo.monitoring.PoolCreatedEvent`,
    :models:`~pymongo.monitoring.PoolClearedEvent`,
    :models:`~pymongo.monitoring.PoolClosedEvent`,
    :~pymongo.monitoring.models:`ConnectionCreatedEvent`,
    :models:`~pymongo.monitoring.ConnectionReadyEvent`,
    :models:`~pymongo.monitoring.ConnectionClosedEvent`,
    :models:`~pymongo.monitoring.ConnectionCheckOutStartedEvent`,
    :models:`~pymongo.monitoring.ConnectionCheckOutFailedEvent`,
    :models:`~pymongo.monitoring.ConnectionCheckedOutEvent`,
    and :models:`~pymongo.monitoring.ConnectionCheckedInEvent`
    events and logs them at the `INFO` severity level using :mod:`logging`.
