...
class Collection(common.BaseObject, Generic[_DocumentType]):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Raises :models:`TypeError` if `name` is not an instance of
        :models:`basestring` (:models:`str` in python 3). Raises
        :models:`~pymongo.errors.InvalidName` if `name` is not a valid
        ...
        :Parameters:
          ...
          - `collation` (optional): An instance of
            :models:`~pymongo.collation.Collation`. If a collation is provided,
            it will be passed to the create collection command.
          - `session` (optional): a
            :models:`~pymongo.client_session.ClientSession` that is used with
        ...
        .. versionchanged:: 3.0
           ...
           :models:`~pymongo.collection.Collection` no longer returns an
           instance of :models:`~pymongo.collection.Collection` for attribute
    ...
    def _command(
        ...
        :Parameters:
          ...
          - `command` - The command itself, as a :models:`~bson.son.SON` instance.
          - `codec_options` (optional) - An instance of
            :models:`~bson.codec_options.CodecOptions`.
          - `check`: raise OperationFailure if there are errors
          - `allowable_errors`: errors to ignore if `check` is True
          - `read_concern` (optional) - An instance of
            :models:`~pymongo.read_concern.ReadConcern`.
          - `write_concern`: An instance of
            :models:`~pymongo.write_concern.WriteConcern`.
          - `collation` (optional) - An instance of
            :models:`~pymongo.collation.Collation`.
          - `session` (optional): a
    ...
    def full_name(self) -> str:
        """The full name of this :models:`Collection`.
    ...
    @property
    def name(self) -> str:
        """The name of this :models:`Collection`."""
        return self.__name

    @property
    def database(self) -> "Database[_DocumentType]":
        """The :models:`~pymongo.database.Database` that this
        :models:`Collection` is a part of.
        """
    ...
    def with_options(
        ...
        :Parameters:
          - `codec_options` (optional): An instance of
            :models:`~bson.codec_options.CodecOptions`. If ``None`` (the
            default) the :attr:`codec_options` of this :models:`Collection`
            is used.
          - `read_preference` (optional): The read preference to use. If
            ``None`` (the default) the :attr:`read_preference` of this
            :models:`Collection` is used. See :mod:`~pymongo.read_preferences`
            for options.
          - `write_concern` (optional): An instance of
            :models:`~pymongo.write_concern.WriteConcern`. If ``None`` (the
            default) the :attr:`write_concern` of this :models:`Collection`
            is used.
          - `read_concern` (optional): An instance of
            :models:`~pymongo.read_concern.ReadConcern`. If ``None`` (the
            default) the :attr:`read_concern` of this :models:`Collection`
            is used.
        """
        return Collection(
            self.__database,
    ...
    def bulk_write(
        ...
        :models:`~pymongo.operations.InsertOne`,
        :models:`~pymongo.operations.UpdateOne`,
        :models:`~pymongo.operations.UpdateMany`,
        :models:`~pymongo.operations.ReplaceOne`,
        :models:`~pymongo.operations.DeleteOne`, or
        :models:`~pymongo.operations.DeleteMany`).
        ...
        :Returns:
          An instance of :models:`~pymongo.results.BulkWriteResult`.
    ...
    def insert_one(
        ...
        :Returns:
          - An instance of :models:`~pymongo.results.InsertOneResult`.
    ...
    def insert_many(
        ...
        :Returns:
          An instance of :models:`~pymongo.results.InsertManyResult`.
    ...
    def replace_one(
        ...
        :Parameters:
          ...
          - `comment` (optional): A user-provided comment to attach to this
            command.
        :Returns:
          - An instance of :models:`~pymongo.results.UpdateResult`.
    ...
    def drop(
        ...
        .. versionchanged:: 3.7
           :meth:`drop` now respects this :models:`Collection`'s :attr:`write_concern`.
    ...
    def delete_one(
        ...
        :Returns:
          - An instance of :models:`~pymongo.results.DeleteResult`.
    ...
    def find(self, *args: Any, **kwargs: Any) -> Cursor[_DocumentType]:
        ...
        Raises :models:`TypeError` if any of the arguments are of
        improper type. Returns an instance of
        :models:`~pymongo.cursor.Cursor` corresponding to this query.
        ...
        :Parameters:
          ...
          - `cursor_type` (optional): the type of cursor to return. The valid
            options are defined by :models:`~pymongo.cursor.CursorType`:
        ...
        .. note:: There are a number of caveats to using
          ...
          - A :models:`~pymongo.cursor.Cursor` instance created with the
            :attr:`~pymongo.cursor.CursorType.EXHAUST` cursor_type requires an
            exclusive :models:`~socket.socket` connection to MongoDB. If the
            :models:`~pymongo.cursor.Cursor` is discarded without being
            completely iterated the underlying :models:`~socket.socket`
        ...
        .. versionchanged:: 3.0
           ...
           represents BSON regular expressions as :models:`~bson.regex.Regex`
    ...
    def find_raw_batches(self, *args: Any, **kwargs: Any) -> RawBatchCursor[_DocumentType]:
        ...
        :models:`~pymongo.cursor.RawBatchCursor`.
    ...
    def create_indexes(
        ...
        **kwargs: Any,
        ...
        :Parameters:
          - `indexes`: A list of :models:`~pymongo.operations.IndexModel`
            instances.
          - `session` (optional): a
            :models:`~pymongo.client_session.ClientSession`.
          - `comment` (optional): A user-provided comment to attach to this
    ...
    def create_index(
        ...
        **kwargs: Any,
        ...
        The key(s) must be an instance of :models:`basestring`
        (:models:`str` in python 3), and the direction(s) must be one of
    ...
    def aggregate(
        ...
        **kwargs: Any,
        ...
        :models:`Collection`, except when ``$out`` or ``$merge`` are used on
        ...
        :Returns:
          A :models:`~pymongo.command_cursor.CommandCursor` over the result
          set.
    ...
    def watch(
        ...
        stage and returns a
        :models:`~pymongo.change_stream.CollectionChangeStream` cursor which
        ...
        The :models:`~pymongo.change_stream.CollectionChangeStream` iterable
        ...
        :Returns:
          A :models:`~pymongo.change_stream.CollectionChangeStream` cursor.
    ...
    def rename(
        ...
        **kwargs: Any,
        ...
        admin to perform this operation. Raises :models:`TypeError` if
        `new_name` is not an instance of :models:`basestring`
        (:models:`str` in python 3). Raises :models:`~pymongo.errors.InvalidName`
    ...
    def distinct(
        ...
        **kwargs: Any,
        ...
        Raises :models:`TypeError` if `key` is not an instance of
        :models:`basestring` (:models:`str` in python 3).
    ...
    def find_one_and_delete(
        ...
        **kwargs: Any,
        ...
        .. warning:: Starting in PyMongo 3.2, this command uses the
           :models:`~pymongo.write_concern.WriteConcern` of this
           :models:`~pymongo.collection.Collection` when connected to MongoDB >=
