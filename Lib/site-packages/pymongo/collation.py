...
class CollationAlternate(object):
    ...
    :models:`~pymongo.collation.Collation` strength is at least
...
class Collation(object):
    ...
    def document(self) -> Dict[str, Any]:
        ...
        .. note::
          :models:`Collation` is immutable. Mutating the value of
          :attr:`document` does not mutate this :models:`Collation`.
        """
