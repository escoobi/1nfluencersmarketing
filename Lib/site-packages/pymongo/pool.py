...
class PoolOptions(object):
    ...
    def _credentials(self):
        """A :models:`~pymongo.auth.MongoCredentials` instance or None."""
    ...
    def non_default_options(self):
        ...
        Added for CMAP's :models:`PoolCreatedEvent`.
        """
        opts = {}
...
class Pool:
    ...
    def get_socket(self, handler=None):
        ...
        Returns a :models:`SocketInfo` object wrapping a connected
    ...
    def _perished(self, sock_info):
        ...
        :models:`~pymongo.errors.AutoReconnect` exceptions on server
