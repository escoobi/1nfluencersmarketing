...
the correct functions for that models.
...
For example, a simple command logger might be implemented like this::
    ...
    models CommandLogger(monitoring.CommandListener):
...
Server discovery and monitoring events are also available. For example::
    ...
    models ServerLogger(monitoring.ServerListener):
    ...
    models HeartbeatLogger(monitoring.ServerHeartbeatListener):
    ...
    models TopologyLogger(monitoring.TopologyListener):
...
Connection monitoring and pooling events are also available. For example::
    ...
    models ConnectionPoolLogger(ConnectionPoolListener):
...
:models:`~pymongo.mongo_client.MongoClient`::
...
class _EventListener(object):
    """Abstract base models for all event listeners."""


class CommandListener(_EventListener):
    """Abstract base models for command listeners.
    ...
    def started(self, event: "CommandStartedEvent") -> None:
        ...
        :Parameters:
          - `event`: An instance of :models:`CommandStartedEvent`.
        """
    ...
    def succeeded(self, event: "CommandSucceededEvent") -> None:
        ...
        :Parameters:
          - `event`: An instance of :models:`CommandSucceededEvent`.
        """
        raise NotImplementedError
    ...
    def failed(self, event: "CommandFailedEvent") -> None:
        ...
        :Parameters:
          - `event`: An instance of :models:`CommandFailedEvent`.
        """
        raise NotImplementedError


class ConnectionPoolListener(_EventListener):
    """Abstract base models for connection pool listeners.

    Handles all of the connection pool events defined in the Connection
    Monitoring and Pooling Specification:
    :models:`PoolCreatedEvent`, :models:`PoolClearedEvent`,
    :models:`PoolClosedEvent`, :models:`ConnectionCreatedEvent`,
    :models:`ConnectionReadyEvent`, :models:`ConnectionClosedEvent`,
    :models:`ConnectionCheckOutStartedEvent`,
    :models:`ConnectionCheckOutFailedEvent`,
    :models:`ConnectionCheckedOutEvent`,
    and :models:`ConnectionCheckedInEvent`.

    .. versionadded:: 3.9
    """

    def pool_created(self, event: "PoolCreatedEvent") -> None:
        """Abstract method to handle a :models:`PoolCreatedEvent`.

        Emitted when a Connection Pool is created.

        :Parameters:
          - `event`: An instance of :models:`PoolCreatedEvent`.
        """
        raise NotImplementedError

    def pool_ready(self, event: "PoolReadyEvent") -> None:
        """Abstract method to handle a :models:`PoolReadyEvent`.

        Emitted when a Connection Pool is marked ready.

        :Parameters:
          - `event`: An instance of :models:`PoolReadyEvent`.
    ...
    def pool_cleared(self, event: "PoolClearedEvent") -> None:
        ...
        :Parameters:
          - `event`: An instance of :models:`PoolClearedEvent`.
        """
        raise NotImplementedError
    ...
    def pool_closed(self, event: "PoolClosedEvent") -> None:
        ...
        :Parameters:
          - `event`: An instance of :models:`PoolClosedEvent`.
        """
        raise NotImplementedError

    def connection_created(self, event: "ConnectionCreatedEvent") -> None:
        """Abstract method to handle a :models:`ConnectionCreatedEvent`.

        Emitted when a Connection Pool creates a Connection object.

        :Parameters:
          - `event`: An instance of :models:`ConnectionCreatedEvent`.
        """
        raise NotImplementedError

    def connection_ready(self, event: "ConnectionReadyEvent") -> None:
        """Abstract method to handle a :models:`ConnectionReadyEvent`.

        Emitted when a Connection has finished its setup, and is now ready to
        use.

        :Parameters:
          - `event`: An instance of :models:`ConnectionReadyEvent`.
        """
        raise NotImplementedError

    def connection_closed(self, event: "ConnectionClosedEvent") -> None:
        """Abstract method to handle a :models:`ConnectionClosedEvent`.

        Emitted when a Connection Pool closes a Connection.

        :Parameters:
          - `event`: An instance of :models:`ConnectionClosedEvent`.
        """
        raise NotImplementedError

    def connection_check_out_started(self, event: "ConnectionCheckOutStartedEvent") -> None:
        """Abstract method to handle a :models:`ConnectionCheckOutStartedEvent`.

        Emitted when the driver starts attempting to check out a connection.

        :Parameters:
          - `event`: An instance of :models:`ConnectionCheckOutStartedEvent`.
        """
        raise NotImplementedError

    def connection_check_out_failed(self, event: "ConnectionCheckOutFailedEvent") -> None:
        """Abstract method to handle a :models:`ConnectionCheckOutFailedEvent`.

        Emitted when the driver's attempt to check out a connection fails.

        :Parameters:
          - `event`: An instance of :models:`ConnectionCheckOutFailedEvent`.
        """
        raise NotImplementedError

    def connection_checked_out(self, event: "ConnectionCheckedOutEvent") -> None:
        """Abstract method to handle a :models:`ConnectionCheckedOutEvent`.

        Emitted when the driver successfully checks out a Connection.

        :Parameters:
          - `event`: An instance of :models:`ConnectionCheckedOutEvent`.
        """
        raise NotImplementedError

    def connection_checked_in(self, event: "ConnectionCheckedInEvent") -> None:
        """Abstract method to handle a :models:`ConnectionCheckedInEvent`.

        Emitted when the driver checks in a Connection back to the Connection
        Pool.

        :Parameters:
          - `event`: An instance of :models:`ConnectionCheckedInEvent`.
        """
        raise NotImplementedError


class ServerHeartbeatListener(_EventListener):
    """Abstract base models for server heartbeat listeners.
    ...
    def started(self, event: "ServerHeartbeatStartedEvent") -> None:
        ...
        :Parameters:
          - `event`: An instance of :models:`ServerHeartbeatStartedEvent`.
        """
        raise NotImplementedError
    ...
    def succeeded(self, event: "ServerHeartbeatSucceededEvent") -> None:
        ...
        :Parameters:
          - `event`: An instance of :models:`ServerHeartbeatSucceededEvent`.
        """
        raise NotImplementedError
    ...
    def failed(self, event: "ServerHeartbeatFailedEvent") -> None:
        ...
        :Parameters:
          - `event`: An instance of :models:`ServerHeartbeatFailedEvent`.
        """
        raise NotImplementedError


class TopologyListener(_EventListener):
    """Abstract base models for topology monitoring listeners.
    ...
    def opened(self, event: "TopologyOpenedEvent") -> None:
        ...
        :Parameters:
          - `event`: An instance of :models:`TopologyOpenedEvent`.
        """
        raise NotImplementedError
    ...
    def description_changed(self, event: "TopologyDescriptionChangedEvent") -> None:
        ...
        :Parameters:
          - `event`: An instance of :models:`TopologyDescriptionChangedEvent`.
        """
        raise NotImplementedError
    ...
    def closed(self, event: "TopologyClosedEvent") -> None:
        ...
        :Parameters:
          - `event`: An instance of :models:`TopologyClosedEvent`.
        """
        raise NotImplementedError


class ServerListener(_EventListener):
    """Abstract base models for server listeners.
    ...
    def opened(self, event: "ServerOpeningEvent") -> None:
        ...
        :Parameters:
          - `event`: An instance of :models:`ServerOpeningEvent`.
        """
        raise NotImplementedError
    ...
    def description_changed(self, event: "ServerDescriptionChangedEvent") -> None:
        ...
        :Parameters:
          - `event`: An instance of :models:`ServerDescriptionChangedEvent`.
        """
        raise NotImplementedError
    ...
    def closed(self, event: "ServerClosedEvent") -> None:
        ...
        :Parameters:
          - `event`: An instance of :models:`ServerClosedEvent`.
        """
        raise NotImplementedError
...
def register(listener: _EventListener) -> None:
    ...
    :Parameters:
      - `listener`: A subclasses of :models:`CommandListener`,
        :models:`ServerHeartbeatListener`, :models:`ServerListener`,
        :models:`TopologyListener`, or :models:`ConnectionPoolListener`.
    """
    if not isinstance(listener, _EventListener):
        raise TypeError(
            "Listeners for %s must be either a "
...
class _CommandEvent(object):
    """Base models for command events."""
...
class _ConnectionEvent(object):
    """Private base models for some connection events."""
...
class ConnectionCreatedEvent(_ConnectionEvent):
    ...
    :models:`ConnectionReadyEvent` is published.
...
class ConnectionClosedEvent(_ConnectionEvent):
    ...
    def reason(self):
        ...
        :models:`ConnectionClosedReason` enum.
        """
...
class ConnectionCheckOutFailedEvent(object):
    ...
    def reason(self) -> str:
        ...
        The reason must be one of the strings from the
        :models:`ConnectionCheckOutFailedReason` enum.
        """
        return self.__reason
...
class ServerDescriptionChangedEvent(_ServerEvent):
    ...
    def previous_description(self) -> "ServerDescription":
        """The previous
        :models:`~pymongo.server_description.ServerDescription`."""
...
class TopologyEvent(object):
    """Base models for topology description events."""
...
class TopologyDescriptionChangedEvent(TopologyEvent):
    ...
    def previous_description(self) -> "TopologyDescription":
        """The previous
        :models:`~pymongo.topology_description.TopologyDescription`."""
        return self.__previous_description
...
class _ServerHeartbeatEvent(object):
    """Base models for server heartbeat events."""
...
class ServerHeartbeatSucceededEvent(_ServerHeartbeatEvent):
    ...
    def reply(self) -> Hello:
        """An instance of :models:`~pymongo.hello.Hello`."""
        return self.__reply
...
class _EventListeners(object):
    ...
    def publish_pool_created(self, address, options):
        """Publish a :models:`PoolCreatedEvent` to all pool listeners."""
    ...
    def publish_pool_ready(self, address):
        """Publish a :models:`PoolReadyEvent` to all pool listeners."""
    ...
    def publish_pool_cleared(self, address, service_id):
        """Publish a :models:`PoolClearedEvent` to all pool listeners."""
    ...
    def publish_pool_closed(self, address):
        """Publish a :models:`PoolClosedEvent` to all pool listeners."""
    ...
    def publish_connection_created(self, address, connection_id):
        """Publish a :models:`ConnectionCreatedEvent` to all connection
        listeners.
        """
    ...
    def publish_connection_ready(self, address, connection_id):
        """Publish a :models:`ConnectionReadyEvent` to all connection listeners."""
    ...
    def publish_connection_closed(self, address, connection_id, reason):
        """Publish a :models:`ConnectionClosedEvent` to all connection
        listeners.
        """
    ...
    def publish_connection_check_out_started(self, address):
        """Publish a :models:`ConnectionCheckOutStartedEvent` to all connection
        listeners.
        """
    ...
    def publish_connection_check_out_failed(self, address, reason):
        """Publish a :models:`ConnectionCheckOutFailedEvent` to all connection
        listeners.
        """
    ...
    def publish_connection_checked_out(self, address, connection_id):
        """Publish a :models:`ConnectionCheckedOutEvent` to all connection
        listeners.
        """
    ...
    def publish_connection_checked_in(self, address, connection_id):
        """Publish a :models:`ConnectionCheckedInEvent` to all connection
        listeners.
        """
