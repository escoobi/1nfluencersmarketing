...
class BaseObject(object):
    """A base models that provides attributes and methods common
    ...
    def codec_options(self) -> CodecOptions:
        """Read only access to the :models:`~bson.codec_options.CodecOptions`
        of this instance.
        """
    ...
    def write_concern(self) -> WriteConcern:
        """Read only access to the :models:`~pymongo.write_concern.WriteConcern`
        of this instance.
    ...
    def read_concern(self) -> ReadConcern:
        """Read only access to the :models:`~pymongo.read_concern.ReadConcern`
        of this instance.
