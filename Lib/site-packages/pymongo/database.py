...
class Database(common.BaseObject, Generic[_DocumentType]):
    ...
    def __init__(
        ...
        :Parameters:
          - `client`: A :models:`~pymongo.mongo_client.MongoClient` instance.
        ...
        .. versionchanged:: 3.0
           ...
           :models:`~pymongo.database.Database` no longer returns an instance
           of :models:`~pymongo.collection.Collection` for attribute names
    ...
    def client(self) -> "MongoClient[_DocumentType]":
        """The client instance for this :models:`Database`."""
        return self.__client

    @property
    def name(self) -> str:
        """The name of this :models:`Database`."""
        return self.__name
    ...
    def get_collection(
        ...
        """Get a :models:`~pymongo.collection.Collection` with the given name
        and options.

        Useful for creating a :models:`~pymongo.collection.Collection` with
        ...
        :Parameters:
          ...
          - `codec_options` (optional): An instance of
            :models:`~bson.codec_options.CodecOptions`. If ``None`` (the
            default) the :attr:`codec_options` of this :models:`Database` is
            used.
          - `read_preference` (optional): The read preference to use. If
            ``None`` (the default) the :attr:`read_preference` of this
            :models:`Database` is used. See :mod:`~pymongo.read_preferences`
            for options.
          - `write_concern` (optional): An instance of
            :models:`~pymongo.write_concern.WriteConcern`. If ``None`` (the
            default) the :attr:`write_concern` of this :models:`Database` is
            used.
          - `read_concern` (optional): An instance of
            :models:`~pymongo.read_concern.ReadConcern`. If ``None`` (the
            default) the :attr:`read_concern` of this :models:`Database` is
            used.
        """
        return Collection(
    ...
    def create_collection(
        ...
        **kwargs: Any,
        ...
        """Create a new :models:`~pymongo.collection.Collection` in this
        database.

        Normally collection creation is automatic. This method should
        only be used to specify options on
        creation. :models:`~pymongo.errors.CollectionInvalid` will be
    ...
    def aggregate(
        ...
        :models:`Database`, except when ``$out`` or ``$merge`` are used, in
    ...
    def watch(
        ...
        stage and returns a
        :models:`~pymongo.change_stream.DatabaseChangeStream` cursor which
        ...
        The :models:`~pymongo.change_stream.DatabaseChangeStream` iterable
        ...
        :Returns:
          A :models:`~pymongo.change_stream.DatabaseChangeStream` cursor.
    ...
    def command(
        ...
        **kwargs: Any,
        ...
        response. If `command` is an instance of :models:`basestring`
        (:models:`str` in python 3) then the command {`command`: `value`}
        will be sent. Otherwise, `command` must be an instance of
        :models:`dict` and will be sent as is.
        ...
        :Parameters:
          - `command`: document representing the command to be issued,
            ...
            .. note:: the order of keys in the `command` document is
               ...
               should use an instance of :models:`~bson.son.SON` or
               a string and kwargs instead of a Python `dict`.

          - `value` (optional): value to use for the command verb when
            `command` is passed as a string
          - `check` (optional): check the response for errors, raising
            :models:`~pymongo.errors.OperationFailure` if there are any
          ...
          - `codec_options`: A :models:`~bson.codec_options.CodecOptions`
            instance.
          - `session` (optional): A
            :models:`~pymongo.client_session.ClientSession`.
          - `comment` (optional): A user-provided comment to attach to this
        ...
        .. versionchanged:: 3.0
           ...
           regular expressions as :models:`~bson.regex.Regex` objects. Use
    ...
    def dereference(
        ...
        **kwargs: Any,
        ...
        """Dereference a :models:`~bson.dbref.DBRef`, getting the
        document it points to.

        Raises :models:`TypeError` if `dbref` is not an instance of
        :models:`~bson.dbref.DBRef`. Returns a document, or ``None`` if
        the reference does not point to a valid document.  Raises
        :models:`ValueError` if `dbref` has a database specified that
