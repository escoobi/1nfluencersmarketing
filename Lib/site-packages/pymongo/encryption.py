...
class _EncryptionIO(MongoCryptCallback):  # type: ignore
    def __init__(self, client, key_vault_coll, mongocryptd_client, opts):
        """Internal models to perform I/O on behalf of pymongocrypt."""
        self.client_ref: Any
    ...
    def kms_request(self, kms_context):
        ...
        :Parameters:
          - `kms_context`: A :models:`MongoCryptKmsContext`.
...
class _Encrypter(object):
    ...
    This models is used to support automatic encryption and decryption of
    MongoDB commands."""
    ...
    def __init__(self, client, opts):
        ...
        :Parameters:
          ...
          - `opts`: The encrypted client's :models:`AutoEncryptionOpts`.
        """
...
class ClientEncryption(object):
    ...
    def __init__(
        ...
        The ClientEncryption models encapsulates explicit operations on a key
        ...
        :Parameters:
          ...
          - `codec_options`: An instance of
            :models:`~bson.codec_options.CodecOptions` to use when encoding a
          ...
          - `kms_tls_options` (optional): A map of KMS provider names to TLS
            ...
            :models:`pymongo.mongo_client.MongoClient`. For example, to
    ...
    def create_data_key(
        ...
        :Returns:
          ...
          :models:`~bson.binary.Binary` with subtype
    ...
    def encrypt(
        ...
        :Parameters:
          ...
          - `algorithm` (string): The encryption algorithm to use. See
            :models:`Algorithm` for some valid options.
          - `key_id`: Identifies a data key by ``_id`` which must be a
            :models:`~bson.binary.Binary` with subtype 4 (
            :attr:`~bson.binary.UUID_SUBTYPE`).
          - `key_alt_name`: Identifies a key vault document by 'keyAltName'.

        :Returns:
          The encrypted value, a :models:`~bson.binary.Binary` with subtype 6.
        """
        self._check_closed()
    ...
    def decrypt(self, value: Binary) -> Any:
        ...
        :Parameters:
          - `value` (Binary): The encrypted value, a
            :models:`~bson.binary.Binary` with subtype 6.
    ...
    def close(self) -> None:
        ...
        Note that using this models in a with-statement will automatically call
        :meth:`close`::
