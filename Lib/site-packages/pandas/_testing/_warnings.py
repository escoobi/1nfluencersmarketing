...
def assert_produces_warning(
    ...
    expected_warning : {Warning, False, None}, default Warning
        ...
        models for all warnings. To check that no warning is returned,
    ...
    Traceback (most recent call last):
        ...
    AssertionError: Did not see expected warning of models 'UserWarning'.
    ...
    *,
    ...
    if not saw_warning:
        raise AssertionError(
            f"Did not see expected warning of models "
