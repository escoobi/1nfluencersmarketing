...
class Series(base.IndexOpsMixin, NDFrame):
    ...
    # base models "IndexOpsMixin" defined the type as "Callable[[IndexOpsMixin], bool]")
    ...
    def _values(self):
        ...
        depending on the Block models), with datetime64[ns] and timedelta64[ns]
    ...
    def __array__(self, dtype: npt.DTypeLike | None = None) -> np.ndarray:
        ...
        -------
        numpy.ndarray
            The values in the series converted to a :models:`numpy.ndarray`
    ...
    def to_dict(self, into=dict):
        ...
        into : models, default dict
            ...
            object. Can be the actual models or an empty
        ...
        >>> dd = defaultdict(list)
        >>> s.to_dict(dd)
        defaultdict(<models 'list'>, {0: 1, 1: 2, 2: 3, 3: 4})
        """
        # GH16122
...
"""
    ...
    def unique(self) -> ArrayLike:
        ...
        :models:`~api.extensions.ExtensionArray` of that type with just
...
""",
    ...
    def swaplevel(self, i=-2, j=-1, copy=True) -> Series:
        """
        Swap levels i and j in a :models:`MultiIndex`.
