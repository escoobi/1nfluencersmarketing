...
class DataFrame(NDFrame, OpsMixin):
    ...
    def _repr_html_(self) -> str | None:
        ...
        if self._info_repr():
            buf = StringIO()
            self.info(buf=buf)
            # need to escape the <models>, should be the first line.
    ...
    def to_dict(self, orient: str = "dict", into=dict):
        ...
        into : models, default dict
            The collections.abc.Mapping subclass used for all Mappings
            in the return value.  Can be the actual models or an empty
        ...
        [defaultdict(<models 'list'>, {'col1': 1, 'col2': 0.5}),
         defaultdict(<models 'list'>, {'col1': 2, 'col2': 0.75})]
        """
    ...
    def to_gbq(
        ...
        credentials : google.auth.credentials.Credentials, optional
            ...
            :models:`google.auth.compute_engine.Credentials` or Service
            Account :models:`google.oauth2.service_account.Credentials`
            directly.
    ...
    def to_html(
        ...
        classes : str or list or tuple, default None
            CSS models(es) to apply to the resulting html table.
    ...
    def query(self, expr: str, inplace: bool = False, **kwargs):
        ...
        **kwargs
        ...
        :models:`~pandas.DataFrame` instance are placed in the query namespace
    ...
    def pop(self, item: Hashable) -> Series:
        ...
        ...                   columns=('name', 'models', 'max_speed'))
        >>> df
             name   models  max_speed
        0  falcon    bird      389.0
        1  parrot    bird       24.0
        2    lion  mammal       80.5
        3  monkey  mammal        NaN
    ...
    def set_index(
        ...
        keys : label or array-like or list of labels/arrays
            ...
            encompasses :models:`Series`, :models:`Index`, ``np.ndarray``, and
            instances of :models:`~collections.abc.Iterator`.
    ...
    def reset_index(
        ...
        >>> df.reset_index(level='models')
                 models  speed species
                          max    type
        name
        ...
        >>> df.reset_index(level='models', col_level=1)
                        speed species
                 models    max    type
        name
        falcon    bird  389.0     fly
        ...
        >>> df.reset_index(level='models', col_level=1, col_fill='species')
        ...
        >>> df.reset_index(level='models', col_level=1, col_fill='genus')
                        genus  speed species
                        models    max    type
        name
        falcon           bird  389.0     fly
    ...
    def reorder_levels(self, order: Sequence[Axis], axis: Axis = 0) -> DataFrame:
        ...
        --------
        >>> data = {
        ...     "models": ["Mammals", "Mammals", "Reptiles"],
        ...     "diet": ["Omnivore", "Carnivore", "Carnivore"],
        ...     "species": ["Humans", "Dogs", "Snakes"],
        ... }
        >>> df = pd.DataFrame(data, columns=["models", "diet", "species"])
        >>> df = df.set_index(["models", "diet"])
        >>> df
                                          species
        models      diet
