...
# and we don't want `stmt` and friends in their so get only the models whose
...
def _op_maker(op_class, op_symbol):
    """
    Return a function to create an op models with its symbol already passed.
...
class BaseExprVisitor(ast.NodeVisitor):
    """
    Custom ast walker. Parsers of other engines should subclass this models
    if necessary.
