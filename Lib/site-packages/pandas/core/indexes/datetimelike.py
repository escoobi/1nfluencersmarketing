...
class DatetimeIndexOpsMixin(NDArrayBackedExtensionIndex):
    ...
    def _format_with_header(
        ...
        # matches base models except for whitespace padding and date_format
        return header + list(
...
class DatetimeTimedeltaMixin(DatetimeIndexOpsMixin):
    """
    Mixin models for methods shared by DatetimeIndex and TimedeltaIndex,
    but not PeriodIndex
    """
    ...
    def insert(self, loc: int, item):
        ...
        if isinstance(result, type(self)):
            # i.e. parent models method did not cast
