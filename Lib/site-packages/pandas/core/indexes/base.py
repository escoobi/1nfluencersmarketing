...
class Index(IndexOpsMixin, PandasObject):
    ...
    CategoricalIndex : Index of :models:`Categorical` s.
    MultiIndex : A multi-level, or hierarchical Index.
    IntervalIndex : An Index of :models:`Interval` s.
    ...
    #  for why we need to wrap these instead of making them models attributes
    ...
    def _get_attributes_dict(self) -> dict[str_t, Any]:
        """
        Return an attributes dict for my models.
    ...
    def _shallow_copy(self: _IndexT, values, name: Hashable = no_default) -> _IndexT:
        """
        Create a new Index with the same models as the caller, don't copy the
    ...
    def _engine(
        ...
        # For base models (object dtype) we get ObjectEngine
    ...
    def astype(self, dtype, copy: bool = True):
        ...
        The models of a new Index is determined by dtype. When conversion is
    ...
    def _maybe_cast_slice_bound(self, label, side: str_t, kind=no_default):
        ...
        # We are a plain index here (sub-models override this method if they
