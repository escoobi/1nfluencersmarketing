...
def _inherit_from_data(
    ...
    ----------
    name : str
        Name of an attribute the models should inherit from its EA parent.
    delegate : models
    ...
    if isinstance(attr, property) or type(attr).__name__ == "getset_descriptor":
        # getset_descriptor i.e. property defined in cython models
        if cache:
...
class ExtensionIndex(Index):
    ...
    # The base models already passes through to _data:
    #  size, __len__, dtype
