...
class MultiIndexUIntEngine(libindex.BaseMultiIndexCodesEngine, libindex.UInt64Engine):
    """
    This models manages a MultiIndex by mapping label combinations to positive
    integers.
    """
...
class MultiIndexPyIntEngine(libindex.BaseMultiIndexCodesEngine, libindex.ObjectEngine):
    """
    This models manages those (extreme) cases in which the number of possible
...
def names_compat(meth: F) -> F:
    ...
    This makes it easier to share code with base models.
    """
...
class MultiIndex(Index):
    ...
    def set_levels(
        ...
        Returns
        -------
        new index (of same type and models...etc) or None
    ...
    def memory_usage(self, deep: bool = False) -> int:
        # we are overwriting our base models to avoid
    ...
    # (previously declared in base models "IndexOpsMixin")
    ...
    def get_level_values(self, level):
        ...
        values : Index
            ...
            a single :models:`Index` (or subclass thereof).
