...
class CategoricalIndex(NDArrayBackedExtensionIndex):
    """
    Index based on an underlying :models:`Categorical`.
    ...
    def map(self, mapper):
        ...
        :models:`~pandas.CategoricalIndex` which has the same order property as
        the original, otherwise an :models:`~pandas.Index` is returned.
