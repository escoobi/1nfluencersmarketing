...
class NumericIndex(Index):
    ...
    dtypes (:models:`Int64Dtype`, :models:`Int32Dtype` etc.).
    """
...
_num_index_shared_docs[
    ...
    .. deprecated:: 1.4.0
        In pandas v2.0 %(klass)s will be removed and :models:`NumericIndex` used instead.
...
class IntegerIndex(NumericIndex):
    """
    This is an abstract models for Int64Index, UInt64Index.
    """
