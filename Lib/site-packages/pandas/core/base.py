...
class PandasObject(DirNamesMixin):
    ...
    def _constructor(self):
        """
        Class constructor (for this models it's just `__class__`.
        """
        return type(self)
...
class IndexOpsMixin(OpsMixin):
    ...
    def array(self) -> ExtensionArray:
        ...
        ExtensionArray
            ...
            is a thin (no copy) wrapper around :models:`numpy.ndarray`.
        ...
        :models:`arrays.NumpyExtensionArray` wrapping the actual ndarray
    ...
    def to_numpy(
        ...
        **kwargs
        ...
        Use ``dtype=object`` to return an ndarray of pandas :models:`Timestamp`
