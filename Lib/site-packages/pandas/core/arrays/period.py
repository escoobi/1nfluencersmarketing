...
class PeriodArray(dtl.DatelikeOps):
    ...
    def asfreq(self, freq=None, how: str = "E") -> PeriodArray:
        ...
        to each :models:`~pandas.Period` in this {klass}.
        ...
        Period.asfreq : Convert a :models:`~pandas.Period` object to the given frequency.
    ...
    def _add_offset(self, other: BaseOffset):
        ...
        # Note: when calling parent models's _add_timedeltalike_scalar,
