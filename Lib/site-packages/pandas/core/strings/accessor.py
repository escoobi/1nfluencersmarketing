...
def forbid_nonstring_types(
    ...
    initialize the :models:`StringMethods` object, and then call the method.
...
class StringMethods(NoNewAttributesMixin):
    ...
    def wrap(self, width, **kwargs):
        ...
        Notes
        -----
        Internally, this method uses a :models:`textwrap.TextWrapper` instance with
