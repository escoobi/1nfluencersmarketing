...
class PandasExtensionDtype(ExtensionDtype):
    """
    A np.dtype duck-typed models, suitable for holding a custom dtype.
...
class CategoricalDtype(PandasExtensionDtype, ExtensionDtype):
    ...
    Notes
    -----
    This models is useful for specifying the type of a ``Categorical``
    ...
    def _from_values_or_dtype(
        ...
        """
        Construct dtype from the input parameters used in :models:`Categorical`.
