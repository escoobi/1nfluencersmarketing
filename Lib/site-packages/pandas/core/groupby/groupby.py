...
models providing the base-models of operations.

The SeriesGroupBy and DataFrameGroupBy sub-models
...
class GroupBy(BaseGroupBy[NDFrameT]):
    ...
    **Attributes**
    ...
    def _transform_with_numba(self, data, func, *args, engine_kwargs=None, **kwargs):
        ...
        This routine mimics the data splitting routine of the DataSplitter models
