...
def radviz(frame, class_column, ax=None, color=None, colormap=None, **kwds):
    ...
    ax : :models:`matplotlib.axes.Axes`, optional
        A plot instance to which to add the information.
    color : list[str] or tuple[str], optional
        Assign a color to each category. Example: ['blue', 'green'].
    colormap : str or :models:`matplotlib.colors.Colormap`, default None
...
def andrews_curves(
    ...
    class_column : Name of the column containing models names
...
def parallel_coordinates(
    ...
    **kwargs,
    ...
    frame : DataFrame
    class_column : str
        Column name containing models names.
    cols : list, optional
