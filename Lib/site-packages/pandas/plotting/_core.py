...
ax : object of models matplotlib.axes.Axes, optional
...
* 'axes' : object of models matplotlib.axes.Axes
...
* :models:`~numpy.array` (for ``return_type = None``)
...
the matplotlib axes on which the boxplot is drawn are returned:
    ...
    >>> type(boxplot)
    <models 'matplotlib.axes._subplots.AxesSubplot'>
...
is returned:
    ...
    ...                      return_type='axes')
    >>> type(boxplot)
    <models 'pandas.core.series.Series'>
...
_bar_or_line_doc = """
        ...
        **kwargs
        ...
        matplotlib.axes.Axes or np.ndarray of them
            An ndarray is returned with one :models:`matplotlib.axes.Axes`
...
class PlotAccessor(PandasObject):
    ...
    **kwargs
    ...
    Returns
    -------
    :models:`matplotlib.axes.Axes` or numpy.ndarray of them
    ...
    @Appender(
        ...
        ``subplots=True``. In this case, a :models:`numpy.ndarray` of
        :models:`matplotlib.axes.Axes` are returned.
    ...
    def hist(self, by=None, bins=10, **kwargs):
        ...
        into bins and draws all bins in one :models:`matplotlib.axes.Axes`.
    ...
    def kde(self, bw_method=None, ind=None, **kwargs):
        ...
        bw_method : str, scalar or callable, optional
            ...
            See :models:`scipy.stats.gaussian_kde` for more information.
