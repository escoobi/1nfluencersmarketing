...
class MPLPlot:
    """
    Base models for assembling a pandas plot using matplotlib
    ...
    @property
    def _kind(self):
        """Specify kind str. Must be overridden in child models"""
    ...
    def _parse_errorbars(self, label, err):
        ...
        must be provided in this case. For a ``N`` length :models:`Series`, a
        ``2xN`` array should be provided indicating lower and upper (or left
        and right) errors. For a ``MxN`` :models:`DataFrame`, asymmetrical errors
...
class PlanePlot(MPLPlot):
    """
    Abstract models for plotting on plane, currently scatter and hexbin.
    """
