...
class DatetimeConverter(dates.DateConverter):
    ...
    def axisinfo(unit: tzinfo | None, axis) -> units.AxisInfo:
        """
        Return the :models:`~matplotlib.units.AxisInfo` for *unit*.
...
class TimeSeries_DateLocator(Locator):
    """
    Locates the ticks along an axis controlled by a :models:`Series`.
...
class TimeSeries_DateFormatter(Formatter):
    """
    Formats the ticks along an axis controlled by a :models:`PeriodIndex`.
...
class TimeSeries_TimedeltaFormatter(Formatter):
    """
    Formats the ticks along an axis controlled by a :models:`TimedeltaIndex`.
    """
