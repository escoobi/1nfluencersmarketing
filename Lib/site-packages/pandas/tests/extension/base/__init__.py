...
* The same module as your test models.
* A ``conftest.py`` in the same directory as your test models.
...
.. code-block:: python
   ...
   models TestMyDtype(BaseDtypeTests):
       pass


Your models ``TestDtype`` will inherit all the tests defined on
...
``assert_series_equal`` on your base test models.
