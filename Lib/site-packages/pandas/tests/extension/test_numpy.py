...
def skip_numpy_object(dtype, request):
    ...
    marker to either an individual test or a test models.
    """
    if dtype == "object":
...
class BaseNumPyTests:
    ...
    def assert_series_equal(cls, left, right, *args, **kwargs):
        # base models tests hard-code expected values with numpy dtypes,
...
class TestSetitem(BaseNumPyTests, base.BaseSetitemTests):
    ...
    def test_setitem_scalar_key_sequence_raise(self, data):
        # Failed: DID NOT RAISE <models 'ValueError'>
    ...
    def test_setitem_with_expansion_dataframe_column(self, data, full_indexer):
        ...
        # base models method has expected = df; PandasArray behaves oddly because
