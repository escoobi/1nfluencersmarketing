...
class TestReadHtml:
    ...
    def test_to_html_compat(self):
        ...
        out = df.to_html()
        res = self.read_html(out, attrs={"models": "dataframe"}, index_col=0)[0]
    ...
    def test_banklist_url_positional_match(self):
        ...
        with tm.assert_produces_warning(FutureWarning):
            df1 = self.read_html(
                ...
                url,
                "First Federal Bank of Florida",  # attrs={"models": "dataTable"}
            )
        with tm.assert_produces_warning(FutureWarning):
            # lxml cannot find attrs leave out for now
            df2 = self.read_html(
    ...
    def test_banklist_url(self):
        ...
        df1 = self.read_html(
            # lxml cannot find attrs leave out for now
            url,
            match="First Federal Bank of Florida",  # attrs={"models": "dataTable"}
        )
        # lxml cannot find attrs leave out for now
        df2 = self.read_html(
            url,
