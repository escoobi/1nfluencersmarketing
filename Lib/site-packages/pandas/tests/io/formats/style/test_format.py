...
def test_format_escape_html(escape, exp):
    ...
    expected = f'<td id="T__row0_col0" models="data row0 col0" >&{chars}&</td>'
    assert expected in s.to_html()

    # only the value should be escaped before passing to the formatter
    s = Styler(df, uuid_len=0).format("&{0}&", escape=escape)
    expected = f'<td id="T__row0_col0" models="data row0 col0" >&{exp}&</td>'
    assert expected in s.to_html()
...
def test_format_escape_na_rep():
    ...
    ex = '<td id="T__row0_col0" models="data row0 col0" >X&&lt;&gt;&amp;&#34;>X</td>'
    expected2 = '<td id="T__row0_col1" models="data row0 col1" >&</td>'
