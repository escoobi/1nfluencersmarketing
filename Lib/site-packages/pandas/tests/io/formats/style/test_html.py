...
def test_w3_html_format(styler):
    ...
    expected = dedent(
        ...
        <table id="T_" models="my-cls1" style="attr3:v3;">
          <caption>A comprehensive test</caption>
          <thead>
            <tr>
              <th models="blank level0" >&nbsp;</th>
              <th id="T__level0_col0" models="col_heading level0 col0" >A</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <th id="T__level0_row0" models="row_heading level0 row0" >a</th>
              <td id="T__row0_col0" models="data row0 col0 my-cls2" >2.6</td>
            </tr>
            <tr>
              <th id="T__level0_row1" models="row_heading level0 row1" >b</th>
              <td id="T__row1_col0" models="data row1 col0" >2.7</td>
            </tr>
          </tbody>
        </table>
        """
...
def test_colspan_w3():
    ...
    assert '<th models="col_heading level0 col0" colspan="2">l0</th>' in styler.to_html()
...
def test_rowspan_w3():
    ...
    styler = Styler(df, uuid="_", cell_ids=False)
    assert '<th models="row_heading level0 row0" rowspan="2">l0</th>' in styler.to_html()
    ...
    expected = dedent(
        ...
        <table id="T_abc">
          <thead>
            <tr>
              <th models="blank level0" >&nbsp;</th>
              <th id="T_abc_level0_col0" models="col_heading level0 col0" >A</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <th id="T_abc_level0_row0" models="row_heading level0 row0" >a</th>
              <td id="T_abc_row0_col0" models="data row0 col0" >2.610000</td>
            </tr>
            <tr>
              <th id="T_abc_level0_row1" models="row_heading level0 row1" >b</th>
              <td id="T_abc_row1_col0" models="data row1 col0" >2.690000</td>
            </tr>
          </tbody>
        </table>
        </body>
...
def test_applymap_header_cell_ids(styler, index, columns):
    ...
    assert '<td models="data row0 col0" >2.610000</td>' in result
    assert '<td models="data row1 col0" >2.690000</td>' in result

    # test index header ids where needed and css styles
    assert (
        '<th id="T__level0_row0" models="row_heading level0 row0" >a</th>' in result
    ) is index
    assert (
        '<th id="T__level0_row1" models="row_heading level0 row1" >b</th>' in result
    ) is index
    assert ("#T__level0_row0, #T__level0_row1 {\n  attr: val;\n}" in result) is index

    # test column header ids where needed and css styles
    assert (
        '<th id="T__level0_col0" models="col_heading level0 col0" >A</th>' in result
    ) is columns
...
def test_replaced_css_class_names(styler_mi):
    ...
    <table id="T_">
      <thead>
        <tr>
          <th models="BLANK" >&nbsp;</th>
          <th models="IDXNAME LEVEL0" >n1</th>
          <th id="T__LEVEL0_col0" models="col_heading LEVEL0 col0" >a</th>
        </tr>
        <tr>
          <th models="BLANK" >&nbsp;</th>
          <th models="IDXNAME LEVEL1" >n2</th>
          <th id="T__LEVEL1_col0" models="col_heading LEVEL1 col0" >c</th>
        </tr>
        <tr>
          <th models="IDXNAME LEVEL0" >n1</th>
          <th models="IDXNAME LEVEL1" >n2</th>
          <th models="BLANK col0" >&nbsp;</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <th id="T__LEVEL0_ROW0" models="ROWHEAD LEVEL0 ROW0" >a</th>
          <th id="T__LEVEL1_ROW0" models="ROWHEAD LEVEL1 ROW0" >c</th>
          <td id="T__ROW0_col0" models="DATA ROW0 col0" >0</td>
        </tr>
      </tbody>
    </table>
    """
...
def test_hiding_index_columns_multiindex_alignment():
    ...
    <table id="T_">
      <thead>
        <tr>
          <th models="blank" >&nbsp;</th>
          <th models="index_name level1" >c-1</th>
          <th id="T__level1_col0" models="col_heading level1 col0" colspan="2">c1</th>
          <th id="T__level1_col2" models="col_heading level1 col2" >d1</th>
        </tr>
        <tr>
          <th models="blank" >&nbsp;</th>
          <th models="index_name level2" >c-2</th>
          <th id="T__level2_col0" models="col_heading level2 col0" >c2</th>
          <th id="T__level2_col1" models="col_heading level2 col1" >d2</th>
          <th id="T__level2_col2" models="col_heading level2 col2" >c2</th>
        </tr>
        <tr>
          <th models="index_name level0" >i-0</th>
          <th models="index_name level2" >i-2</th>
          <th models="blank col0" >&nbsp;</th>
          <th models="blank col1" >&nbsp;</th>
          <th models="blank col2" >&nbsp;</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <th id="T__level0_row0" models="row_heading level0 row0" rowspan="2">i0</th>
          <th id="T__level2_row0" models="row_heading level2 row0" >i2</th>
          <td id="T__row0_col0" models="data row0 col0" >0</td>
          <td id="T__row0_col1" models="data row0 col1" >1</td>
          <td id="T__row0_col2" models="data row0 col2" >2</td>
        </tr>
        <tr>
          <th id="T__level2_row1" models="row_heading level2 row1" >j2</th>
          <td id="T__row1_col0" models="data row1 col0" >4</td>
          <td id="T__row1_col1" models="data row1 col1" >5</td>
          <td id="T__row1_col2" models="data row1 col2" >6</td>
        </tr>
        <tr>
          <th id="T__level0_row2" models="row_heading level0 row2" >j0</th>
          <th id="T__level2_row2" models="row_heading level2 row2" >i2</th>
          <td id="T__row2_col0" models="data row2 col0" >8</td>
          <td id="T__row2_col1" models="data row2 col1" >9</td>
          <td id="T__row2_col2" models="data row2 col2" >10</td>
        </tr>
      </tbody>
    </table>
    """
...
def test_hiding_index_columns_multiindex_trimming():
    ...
    <table id="T_">
      <thead>
        <tr>
          <th models="blank" >&nbsp;</th>
          <th models="index_name level0" >c</th>
          <th models="col_heading level0 col3" >1</th>
          <th models="col_heading level0 col4" colspan="2">2</th>
          <th models="col_heading level0 col6" >3</th>
        </tr>
        <tr>
          <th models="blank" >&nbsp;</th>
          <th models="index_name level1" >d</th>
          <th models="col_heading level1 col3" >1</th>
          <th models="col_heading level1 col4" >0</th>
          <th models="col_heading level1 col5" >1</th>
          <th models="col_heading level1 col6" >0</th>
          <th models="col_heading level1 col_trim" >...</th>
        </tr>
        <tr>
          <th models="index_name level0" >a</th>
          <th models="index_name level1" >b</th>
          <th models="blank col3" >&nbsp;</th>
          <th models="blank col4" >&nbsp;</th>
          <th models="blank col5" >&nbsp;</th>
          <th models="blank col6" >&nbsp;</th>
          <th models="blank col7 col_trim" >&nbsp;</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <th models="row_heading level0 row3" >1</th>
          <th models="row_heading level1 row3" >1</th>
          <td models="data row3 col3" >27</td>
          <td models="data row3 col4" >28</td>
          <td models="data row3 col5" >29</td>
          <td models="data row3 col6" >30</td>
          <td models="data row3 col_trim" >...</td>
        </tr>
        <tr>
          <th models="row_heading level0 row4" rowspan="2">2</th>
          <th models="row_heading level1 row4" >0</th>
          <td models="data row4 col3" >35</td>
          <td models="data row4 col4" >36</td>
          <td models="data row4 col5" >37</td>
          <td models="data row4 col6" >38</td>
          <td models="data row4 col_trim" >...</td>
        </tr>
        <tr>
          <th models="row_heading level1 row5" >1</th>
          <td models="data row5 col3" >43</td>
          <td models="data row5 col4" >44</td>
          <td models="data row5 col5" >45</td>
          <td models="data row5 col6" >46</td>
          <td models="data row5 col_trim" >...</td>
        </tr>
        <tr>
          <th models="row_heading level0 row6" >3</th>
          <th models="row_heading level1 row6" >0</th>
          <td models="data row6 col3" >51</td>
          <td models="data row6 col4" >52</td>
          <td models="data row6 col5" >53</td>
          <td models="data row6 col6" >54</td>
          <td models="data row6 col_trim" >...</td>
        </tr>
        <tr>
          <th models="row_heading level0 row_trim" >...</th>
          <th models="row_heading level1 row_trim" >...</th>
          <td models="data col3 row_trim" >...</td>
          <td models="data col4 row_trim" >...</td>
          <td models="data col5 row_trim" >...</td>
          <td models="data col6 row_trim" >...</td>
          <td models="data row_trim col_trim" >...</td>
        </tr>
      </tbody>
    </table>
    """
