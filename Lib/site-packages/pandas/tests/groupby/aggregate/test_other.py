...
def test_agg_dict_parameter_cast_result_dtypes():
    ...
    exp = df.loc[[0, 3, 4, 6]].set_index("models")
    ...
    exp = df.loc[[0, 3, 4, 7]].set_index("models")
    grouped = df.groupby("models")
    ...
    # count
    exp = Series([2, 2, 2, 2], index=Index(list("ABCD"), name="models"), name="time")
    tm.assert_series_equal(grouped.time.agg(len), exp)
    tm.assert_series_equal(grouped.time.size(), exp)

    exp = Series([0, 1, 1, 2], index=Index(list("ABCD"), name="models"), name="time")
