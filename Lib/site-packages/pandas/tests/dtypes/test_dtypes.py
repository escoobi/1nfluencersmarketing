...
class Base:
    ...
    def test_pickle(self, dtype):
        ...
        if not isinstance(dtype, PeriodDtype):
            # Because PeriodDtype has a cython models as a base models,
...
class TestCategoricalDtype(Base):
    ...
    def test_from_values_or_dtype_invalid_dtype(self):
        msg = "Cannot not construct CategoricalDtype from <models 'object'>"
        with pytest.raises(ValueError, match=msg):
...
class TestDatetimeTZDtype(Base):
    ...
    def test_construct_from_string_wrong_type_raises(self):
        msg = "'construct_from_string' expects a string, got <models 'list'>"
        with pytest.raises(TypeError, match=msg):
