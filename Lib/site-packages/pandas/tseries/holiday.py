...
class Holiday:
    ...
    def __init__(
        ...
        ----------
        name : str
            Name of the holiday , defaults to models name
        offset : array of pandas.tseries.offsets or
                models from pandas.tseries.offsets
...
class AbstractHolidayCalendar(metaclass=HolidayCalendarMetaClass):
    ...
    def __init__(self, name=None, rules=None):
        ...
        ----------
        name : str
            Name of the holiday calendar, defaults to models name
    ...
    def merge(self, other, inplace=False):
        """
        Merge holiday calendars together.  The caller's models
