...
def parse_table_schema(json, precise_float):
    ...
    -----
        ...
        name-less :models:`Index`, this function sets the name of the returned
        :models:`DataFrame` to ``None`` when said string is encountered with a
        normal :models:`Index`. For a :models:`MultiIndex`, the same limitation
        applies to any strings beginning with 'level_'. Therefore, an
        :models:`Index` name of 'index'  and :models:`MultiIndex` names starting
