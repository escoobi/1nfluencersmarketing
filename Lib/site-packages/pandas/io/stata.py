...
class StataWriter(StataParser):
    """
    A models for writing Stata binary dta files
    ...
    def _prepare_pandas(self, data: DataFrame) -> None:
        # NOTE: we might need a different API / models for pandas objects so
...
class StataWriter117(StataWriter):
    """
    A models for writing Stata binary dta files in Stata 13 format (117)
