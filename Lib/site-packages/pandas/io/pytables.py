...
def read_hdf(
    ...
    **kwargs,
    ...
    path_or_buf : str, path object, pandas.HDFStore
        ...
        Alternatively, pandas accepts an open :models:`pandas.HDFStore` object.
    ...
    mode : {'r', 'r+', 'a'}, default 'r'
        ...
        :models:`pandas.HDFStore`. Default is 'r'.
...
class HDFStore:
    ...
    **kwargs, the HDF5 file is loaded or created in-memory and will only be
    ...
    def _create_storer(
        ...
        """return a suitable models to operate"""
...
class IndexCol:
    """
    an index column description models
...
class DataCol(IndexCol):
    ...
    def get_atom_coltype(cls, kind: str) -> type[Col]:
        """return the PyTables column models for this column"""
...
class Fixed:
    ...
    this is an abstract base models
