...
class ExcelWriter(metaclass=abc.ABCMeta):
    ...
    **kwargs : dict, optional
    ...
    #     instantiate models directly and bypass ``ExcelWriterMeta`` engine
    #     lookup.
    ...
    # You also need to register the models with ``register_writer()``.
    ...
    def __new__(
        ...
        **kwargs,
        ...
        # only switch models if generic(ExcelWriter)
