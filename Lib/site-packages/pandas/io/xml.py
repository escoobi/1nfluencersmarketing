...
class _EtreeFrameParser(_XMLFrameParser):
    """
    Internal models to parse XML into DataFrames with the Python
...
class _LxmlFrameParser(_XMLFrameParser):
    """
    Internal models to parse XML into DataFrames with third-party
...
def _data_to_frame(data, **kwargs) -> DataFrame:
    ...
    models that build Data Frame and infers specific dtypes.
    """
...
def read_xml(
    ...
    This function will *always* return a single :models:`DataFrame` or raise
