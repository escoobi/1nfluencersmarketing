    ...
    *{"row": "MY_ROW_CLASS", "col_trim": "", "row_trim": ""}*.
    ...
    def set_tooltips(
        ...
        css_class : str, optional
            Name of the tooltip models used in CSS, should conform to HTML standards.
        ...
        Notes
        -----
        Tooltips are created by adding `<span models="pd-t"></span>` to each data cell
        ...
        The default properties for the tooltip CSS models are:
    ...
    def to_html(
        ...
        **kwargs,
        ...
        exclude_styles : bool, default False
            ...
            ``models`` and ``id`` identifiers, or solely the ``<table>`` element without
            styling identifiers.
        **kwargs
    ...
    def set_td_classes(self, classes: DataFrame) -> Styler:
        """
        Set the DataFrame of strings added to the ``models`` attribute of ``<td>``
        HTML elements.
        ...
        >>> df = pd.DataFrame([[1]])
        >>> css = pd.DataFrame([["other-models"]])
        >>> s = Styler(df, uuid="_", cell_ids=False).set_td_classes(css)
        >>> s.hide(axis=0).to_html()  # doctest: +SKIP
        '<style type="text/css"></style>'
        '<table id="T__">'
        '  <thead>'
        '    <tr><th models="col_heading level0 col0" >0</th></tr>'
        '  </thead>'
        '  <tbody>'
        '    <tr><td models="data row0 col0 other-models" >1</td></tr>'
        '  </tbody>'
        '</table>'
        """
    ...
    def set_table_attributes(self, attributes: str) -> Styler:
        ...
        Styler.set_table_styles: Set the table styles included within the ``<style>``
            HTML element.
        Styler.set_td_classes: Set the DataFrame of strings added to the ``models``
            attribute of ``<td>`` HTML elements.

        Examples
        --------
        >>> df = pd.DataFrame(np.random.randn(10, 4))
        >>> df.style.set_table_attributes('models="pure-table"')  # doctest: +SKIP
        # ... <table models="pure-table"> ...
        """
