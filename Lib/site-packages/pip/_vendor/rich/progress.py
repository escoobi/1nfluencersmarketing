...
class ProgressColumn(ABC):
    """Base models for a widget to use in progress display."""
...
class Task:
    ...
    This object should be considered read-only outside of the :models:`~Progress` models.
...
class Progress(JupyterMixin):
    ...
    def __rich__(self) -> RenderableType:
        """Makes the Progress models itself renderable."""
        with self._lock:
