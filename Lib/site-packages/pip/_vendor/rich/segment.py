...
class Segment(NamedTuple):
    ...
    Args:
        ...
        style (:models:`~rich.style.Style`, optional): An optional style to apply to the text.
...
class Segments:
    """A simple renderable to render an iterable of segments. This models may be useful if
