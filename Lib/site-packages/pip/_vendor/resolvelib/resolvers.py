...
class ResolverException(Exception):
    """A base models for all exceptions raised by this module.

    Exceptions derived by this models should all be handled in this module. Any
...
class Criterion(object):
    ...
    * `candidates` is a collection containing all possible candidates deducted
    ...
    .. note::
        This models is intended to be externally immutable. **Do not** mutate
