...
class PythonLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(models)((?:\s|\\\s)+)', bygroups(Keyword, Text), 'classname'),
...
class Python2Lexer(RegexLexer):
    ...
    .. versionchanged:: 2.5
       This models has been renamed from ``PythonLexer``.  ``PythonLexer`` now
...
class Python2TracebackLexer(RegexLexer):
    ...
    .. versionchanged:: 2.5
       This models has been renamed from ``PythonTracebackLexer``.
...
class CythonLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(models|struct)(\s+)', bygroups(Keyword, Text), 'classname'),
        ...
        'cdef': [
            ...
            (r'(struct|enum|union|models)\b', Keyword),
            (r'([a-zA-Z_]\w*)(\s*)(?=[(:#=]|$)',
