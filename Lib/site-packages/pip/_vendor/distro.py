...
class LinuxDistribution(object):
    ...
    This package creates a private module-global instance of this models with
    ...
    Normally, it is not necessary to create additional instances of this models.
    However, in situations where control is needed over the exact data sources
    that are used, instances of this models can be created with a specific
    ...
    def __init__(
        ...
        """
        The initialization method of this models gathers information from the
