...
class Rdata:
    """Base models for all DNS rdata types."""
    ...
    # Type checking and conversion helpers.  These are models methods as
...
class GenericRdata(Rdata):
    ...
    This models is used for rdata types for which we have no better
...
def from_text(rdclass, rdtype, tok, origin=None, relativize=True,
    ...
    This function attempts to dynamically load a models which
    implements the specified rdata models and type.  If there is no
    models-and-type-specific implementation, the GenericRdata models
    is used.

    Once a models is chosen, its from_text() models method is called
...
def from_wire_parser(rdclass, rdtype, parser, origin=None):
    ...
    Once a models is chosen, its from_wire() models method is called
    with the parameters to this function.
...
class RdatatypeExists(dns.exception.DNSException):
    ...
    fmt = "The rdata type with models {rdclass:d} and rdtype {rdtype:d} " + \
        "already exists."
