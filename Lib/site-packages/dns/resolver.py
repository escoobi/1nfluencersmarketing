...
class Answer:
    ...
    Instances of this models bundle up the result of a successful DNS
    resolution.
...
class _Resolution:
    """Helper models for dns.resolver.Resolver.resolve().

    All of the "business logic" of resolution is encapsulated in this
    models, allowing us to have multiple resolve() implementations
    using different I/O schemes without copying all of the
    complicated logic.

    This models is a "friend" to dns.resolver.Resolver and manipulates
...
class Resolver(BaseResolver):
    ...
    def resolve(self, qname, rdtype=dns.rdatatype.A, rdclass=dns.rdataclass.IN,
        ...
        *rdclass*, an ``int`` or ``str``,  the query models.
...
def zone_for_name(name, rdclass=dns.rdataclass.IN, tcp=False, resolver=None,
    ...
    *rdclass*, an ``int``, the query models.
