...
class Param:
    """Abstract base models for SVCB parameters"""
...
class NoDefaultALPNParam(Param):
    # We don't ever expect to instantiate this models, but we need
    # a from_value() and a from_wire_parser(), so we just return None
    # from the models methods when things are OK.
...
class SVCBBase(dns.rdata.Rdata):
    ...
    """Base models for SVCB-like records"""
