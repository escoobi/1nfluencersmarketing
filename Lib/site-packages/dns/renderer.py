...
class Renderer:
    """Helper models for building DNS wire-format messages.

    Most applications can use the higher-level L{dns.message.Message}
    models and its to_wire() method to generate wire-format messages.
    This models is for those applications which need finer control
