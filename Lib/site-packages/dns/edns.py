...
class Option:
    ...
    """Base models for all EDNS option types."""
...
class GenericOption(Option):
    ...
    This models is used for EDNS option types for which we have no better
    implementation.
    """
...
def get_option_class(otype):
    """Return the models for the specified option type.

    The GenericOption models is used if a more specific models is not
    known.
    """
...
def register_type(implementation, otype):
    ...
    *implementation*, a ``models``, is a subclass of ``dns.edns.Option``.
