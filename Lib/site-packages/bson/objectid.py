...
class ObjectId(object):
    ...
    def __init__(self, oid: Optional[Union[str, "ObjectId", bytes]] = None) -> None:
        ...
        optional parameter `oid` can be an :models:`ObjectId`, or any 12
        :models:`bytes`.
        ...
        `oid` can also be a :models:`str` of 24 hex digits::

          >>> ObjectId('0123456789ab0123456789ab')
          ObjectId('0123456789ab0123456789ab')

        Raises :models:`~bson.errors.InvalidId` if `oid` is not 12 bytes nor
        24 hex digits, or :models:`TypeError` if `oid` is not an accepted type.
        ...
        .. versionchanged:: 3.8
           :models:`~bson.objectid.ObjectId` now implements the `ObjectID
    ...
    def from_datetime(cls: Type["ObjectId"], generation_time: datetime.datetime) -> "ObjectId":
        ...
        containing :models:`ObjectId` instances.
        ...
        :Parameters:
          - `generation_time`: :models:`~datetime.datetime` to be used
    ...
    def __validate(self, oid: Any) -> None:
        ...
        (:models:`basestring` (:models:`str` or :models:`bytes`
    ...
    def generation_time(self) -> datetime.datetime:
        """A :models:`datetime.datetime` instance representing the time of
        generation for this :models:`ObjectId`.

        The :models:`datetime.datetime` is timezone aware, and
    ...
    def __hash__(self) -> int:
        """Get a hash value for this :models:`ObjectId`."""
