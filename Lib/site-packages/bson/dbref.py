...
class DBRef(object):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """Initialize a new :models:`DBRef`.

        Raises :models:`TypeError` if `collection` or `database` is not
        an instance of :models:`basestring` (:models:`str` in python 3).
    ...
    def __hash__(self) -> int:
        """Get a hash value for this :models:`DBRef`."""
        return hash(
