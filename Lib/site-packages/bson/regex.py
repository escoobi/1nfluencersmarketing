...
class Regex(Generic[_T]):
    ...
    def from_native(cls: Type["Regex"], regex: "Pattern[_T]") -> "Regex[_T]":
        ...
        :models:`str` has the ``re.UNICODE`` flag set. If it is undesirable
    ...
    def __init__(self, pattern: _T, flags: Union[str, int] = 0) -> None:
        ...
        This models is useful to store and retrieve regular expressions that are
    ...
    def try_compile(self) -> "Pattern[_T]":
        """Compile this :models:`Regex` as a Python regular expression.
