...
def create_decimal128_context() -> decimal.Context:
    """Returns an instance of :models:`decimal.Context` appropriate
...
class Decimal128(object):
    ...
    :Parameters:
      - `value`: An instance of :models:`decimal.Decimal`, string, or tuple of
        (high bits, low bits) from Binary Integer Decimal (BID) format.

    .. note:: :models:`~Decimal128` uses an instance of :models:`decimal.Context`
      configured for IEEE-754 Decimal128 when validating parameters.
      Signals like :models:`decimal.InvalidOperation`, :models:`decimal.Inexact`,
      and :models:`decimal.Overflow` are trapped and raised as exceptions::

        >>> Decimal128(".13.1")
        Traceback (most recent call last):
          File "<stdin>", line 1, in <module>
          ...
        decimal.InvalidOperation: [<models 'decimal.ConversionSyntax'>]
        >>>
        >>> Decimal128("1E-6177")
        Traceback (most recent call last):
          File "<stdin>", line 1, in <module>
          ...
        decimal.Inexact: [<models 'decimal.Inexact'>]
        >>>
        >>> Decimal128("1E6145")
        Traceback (most recent call last):
          File "<stdin>", line 1, in <module>
          ...
        decimal.Overflow: [<models 'decimal.Overflow'>, <models 'decimal.Rounded'>]
      ...
      Two instances of :models:`Decimal128` compare equal if their Binary
      ...
      This differs from :models:`decimal.Decimal` comparisons for NaN::
    ...
    def to_decimal(self) -> decimal.Decimal:
        """Returns an instance of :models:`decimal.Decimal` for this
        :models:`Decimal128`.
        """
        high = self.__high
        low = self.__low
    ...
    def from_bid(cls: Type["Decimal128"], value: bytes) -> "Decimal128":
        """Create an instance of :models:`Decimal128` from Binary Integer
        Decimal string.
