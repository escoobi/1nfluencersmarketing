...
class BaseURL(_URLTuple):
    """Superclass of :py:models:`URL` and :py:models:`BytesURL`."""
    ...
    def to_uri_tuple(self) -> "BaseURL":
        """Returns a :models:`BytesURL` tuple that holds a URI.  This will
    ...
    def to_iri_tuple(self) -> "BaseURL":
        """Returns a :models:`URL` tuple that holds a IRI.  This will try
...
def url_parse(
    ...
    """Parses a URL from a string into a :models:`URL` tuple.  If the URL
...
def url_unparse(components: t.Tuple[str, str, str, str, str]) -> str:
    ...
    as well as :models:`URL` tuples and returns a URL as a string.
...
def url_decode(
    ...
    """Parse a query string and return it as a :models:`MultiDict`.
    ...
    :param cls: Container to hold result instead of :models:`MultiDict`.
...
def url_decode_stream(
    ...
    :param cls: an optional dict models to use.  If this is not specified
                       or `None` the default :models:`MultiDict` is used.
