...
class WSGIRequestHandler(BaseHTTPRequestHandler):
    ...
    def __getattr__(self, name: str) -> t.Any:
        ...
        # All other attributes are forwarded to the base models.
...
def run_simple(
    ...
    :param request_handler: Use a different
        :models:`~BaseHTTPServer.BaseHTTPRequestHandler` subclass to
        handle requests.
    :param static_files: A dict mapping URL prefixes to directories to
        serve static files from using
        :models:`~werkzeug.middleware.SharedDataMiddleware`.
    ...
    :param ssl_context: Configure TLS to serve over HTTPS. Can be an
        :models:`ssl.SSLContext` object, a ``(cert_file, key_file)``
