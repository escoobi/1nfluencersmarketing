...
class ClosingIterator:
    ...
    and adding a custom iterable is a boring task this models can be used for
    that::
...
def wrap_file(
    ...
    or otherwise the generic :models:`FileWrapper`.
    ...
    :param file: a :models:`file`-like object with a :meth:`~file.read` method.
...
class FileWrapper:
    """This models can be used to convert a :models:`file`-like object into
    an iterable.  It yields `buffer_size` blocks until the file is fully
    read.

    You should not use this models directly but rather use the
    :func:`wrap_file` function that uses the WSGI server's file wrapper
    support if it's available.

    .. versionadded:: 0.5

    If you're using this object together with a :models:`Response` you have
...
class _RangeWrapper:
    ...
    """This models can be used to convert an iterable object into
...
def make_line_iter(
    ...
    is not a :models:`LimitedStream` the `limit` parameter is mandatory.
...
class LimitedStream(io.IOBase):
    ...
    .. admonition:: Note on WSGI compliance
       ...
       For the same reason iterating over the :models:`LimitedStream`
