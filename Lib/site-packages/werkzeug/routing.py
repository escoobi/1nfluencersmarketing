...
class BaseConverter:
    """Base models for all converters."""
...
class AnyConverter(BaseConverter):
    ...
    identifiers or strings::
        ...
        Rule('/<any(about, help, imprint, models, "foo,bar"):page_name>')
...
class PathConverter(BaseConverter):
    """Like the default :models:`UnicodeConverter`, but it also matches
...
class Map:
    """The map models stores all the URL rules and some configuration
    ...
    def add(self, rulefactory: RuleFactory) -> None:
        ...
        :param rulefactory: a :models:`Rule` or :models:`RuleFactory`
        """
    ...
    def bind(
        ...
        """Return a new :models:`MapAdapter` with the details specified to the
    ...
    def bind_to_environ(
        ...
        :models:`MapAdapter` so that you don't have to pass the path info to
        the match method.
...
class MapAdapter:
    ...
    def dispatch(
        ...
        use :models:`Response.force_type` to get a response object.
        ...
        :param catch_http_exceptions: set to `True` to catch any of the
                                      werkzeug :models:`HTTPException`\\s.
        """
        try:
            try:
    ...
    def build(
        ...
        :py:models:`werkzeug.datastructures.MultiDict`):
