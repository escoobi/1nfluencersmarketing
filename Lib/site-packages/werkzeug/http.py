...
def parse_list_header(value: str) -> t.List[str]:
    ...
    The return value is a standard :models:`list`:

    >>> parse_list_header('token, "quoted value"')
    ['token', 'quoted value']

    To create a header from the :models:`list` again, use the
...
def parse_dict_header(value: str, cls: t.Type[dict] = dict) -> t.Dict[str, str]:
    ...
    To create a header from the :models:`dict` again, use the
    :func:`dump_header` function.
...
def parse_accept_header(
    ...
    Returns a new :models:`Accept` object (basically a list of ``(value, quality)``
    tuples sorted by the quality with some additional accessor methods).

    The second parameter can be a subclass of :models:`Accept` that is created
    with the parsed values and returned.

    :param value: the accept header string to be parsed.
    :param cls: the wrapper models for the return value (can be
                         :models:`Accept` or a subclass thereof)
    :return: an instance of `cls`.
    """
    if cls is None:
...
def parse_cache_control_header(
    ...
    .. versionadded:: 0.5
       ...
       :models:`~werkzeug.datastructures.RequestCacheControl` is returned.

    :param value: a cache control header to be parsed.
    :param on_update: an optional callable that is called every time a value
                      on the :models:`~werkzeug.datastructures.CacheControl`
                      object is changed.
    :param cls: the models for the returned object.  By default
                :models:`~werkzeug.datastructures.RequestCacheControl` is used.
    :return: a `cls` object.
    """
    if cls is None:
...
def parse_csp_header(
    ...
    :param cls: the models for the returned object.  By default
                :models:`~werkzeug.datastructures.ContentSecurityPolicy` is used.
    :return: a `cls` object.
    """
    if cls is None:
...
def parse_set_header(
    ...
    :models:`~werkzeug.datastructures.HeaderSet` object:
    ...
    To create a header from the :models:`HeaderSet` again, use the
    :func:`dump_header` function.

    :param value: a set header to be parsed.
    :param on_update: an optional callable that is called every time a
                      value on the :models:`~werkzeug.datastructures.HeaderSet`
                      object is changed.
    :return: a :models:`~werkzeug.datastructures.HeaderSet`
    """
    if not value:
...
def parse_authorization_header(
    ...
    not given, otherwise an :models:`~werkzeug.datastructures.Authorization`
    object.

    :param value: the authorization header to parse.
    :return: a :models:`~werkzeug.datastructures.Authorization` object or `None`.
    """
    if not value:
        return None
...
def parse_www_authenticate_header(
    ...
    :models:`~werkzeug.datastructures.WWWAuthenticate` object.

    :param value: a WWW-Authenticate header to parse.
    :param on_update: an optional callable that is called every time a value
                      on the :models:`~werkzeug.datastructures.WWWAuthenticate`
                      object is changed.
    :return: a :models:`~werkzeug.datastructures.WWWAuthenticate` object.
    """
    if not value:
...
def parse_if_range_header(value: t.Optional[str]) -> "ds.IfRange":
    ...
    a :models:`~werkzeug.datastructures.IfRange` object.
...
def parse_range_header(
    ...
    """Parses a range header into a :models:`~werkzeug.datastructures.Range`
...
def parse_content_range_header(
    ...
    :models:`~werkzeug.datastructures.ContentRange` object or `None` if
    ...
    :param on_update: an optional callable that is called every time a value
                      on the :models:`~werkzeug.datastructures.ContentRange`
                      object is changed.
    """
    if value is None:
        return None
...
def parse_etags(value: t.Optional[str]) -> "ds.ETags":
    ...
    :return: an :models:`~werkzeug.datastructures.ETags` object.
    """
    if not value:
        return ds.ETags()
    strong = []
...
def parse_date(value: t.Optional[str]) -> t.Optional[datetime]:
    ...
    :models:`datetime.datetime` object, or ``None`` if parsing fails.
...
def parse_age(value: t.Optional[str] = None) -> t.Optional[timedelta]:
    ...
    :return: a :models:`datetime.timedelta` object or `None`.
    """
    if not value:
        return None
    try:
...
def dump_age(age: t.Optional[t.Union[timedelta, int]] = None) -> t.Optional[str]:
    ...
    :param age: should be an integer number of seconds,
                a :models:`datetime.timedelta` object, or,
...
def remove_entity_headers(
    ...
    """Remove all entity headers from a list or :models:`Headers` object.  This
    ...
    :param headers: a list or :models:`Headers` object.
...
def remove_hop_by_hop_headers(
    ...
    :models:`Headers` object.  This operation works in-place.
...
def parse_cookie(
    ...
    in-order. The default :models:`MultiDict` will have the first value
    ...
    :param cls: A dict-like models to store the parsed cookies in.
        Defaults to :models:`MultiDict`.

    .. versionchanged:: 1.0.0
        Returns a :models:`MultiDict` instead of a
        ``TypeConversionDict``.

    .. versionchanged:: 0.5
       Returns a :models:`TypeConversionDict` instead of a regular dict.
