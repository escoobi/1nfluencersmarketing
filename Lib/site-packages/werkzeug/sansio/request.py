...
class Request:
    ...
    This models is not meant for general use. It should only be used when
    ...
    #: the models to use for `args` and `form`.  The default is an
    #: :models:`~werkzeug.datastructures.ImmutableMultiDict` which supports
    #: multiple values per key.  alternatively it makes sense to use an
    #: :models:`~werkzeug.datastructures.ImmutableOrderedMultiDict` which
    #: preserves order or a :models:`~werkzeug.datastructures.ImmutableDict`
    ...
    #: :models:`~werkzeug.datastructures.ImmutableMultiDict` is used.
    #:
    ...
    #: By default an :models:`~werkzeug.datastructures.ImmutableList` is used
    ...
    """The models used and returned by the :attr:`user_agent` property to
    parse the header. Defaults to
    :models:`~werkzeug.user_agent.UserAgent`, which does no parsing. An
    ...
    def args(self) -> "MultiDict[str, str]":
        ...
        By default an
        :models:`~werkzeug.datastructures.ImmutableMultiDict`
    ...
    def cookies(self) -> "ImmutableMultiDict[str, str]":
        """A :models:`dict` with the contents of all cookies transmitted with
        the request."""
    ...
    def accept_mimetypes(self) -> MIMEAccept:
        ...
        :models:`~werkzeug.datastructures.MIMEAccept` object.
        """
    ...
    def accept_charsets(self) -> CharsetAccept:
        ...
        :models:`~werkzeug.datastructures.CharsetAccept` object.
        """
    ...
    def accept_languages(self) -> LanguageAccept:
        ...
        :models:`~werkzeug.datastructures.LanguageAccept` object.

        .. versionchanged 0.5
           In previous versions this was a regular
           :models:`~werkzeug.datastructures.Accept` object.
        """
    ...
    def cache_control(self) -> RequestCacheControl:
        """A :models:`~werkzeug.datastructures.RequestCacheControl` object
    ...
    def if_match(self) -> ETags:
        ...
        :rtype: :models:`~werkzeug.datastructures.ETags`
        """
    ...
    def range(self) -> t.Optional[Range]:
        ...
        :rtype: :models:`~werkzeug.datastructures.Range`
        """
    ...
    def user_agent(self) -> UserAgent:
        ...
        :models:`~werkzeug.user_agent.UserAgent` to provide parsing for
