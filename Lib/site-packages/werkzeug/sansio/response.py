...
class Response:
    ...
    # A :models:`Headers` object representing the response headers.
    headers: Headers
    ...
    def content_range(self) -> ContentRange:
        ...
        :models:`~werkzeug.datastructures.ContentRange` object. Available
    ...
    def content_security_policy(self) -> ContentSecurityPolicy:
        ...
        :models:`~werkzeug.datastructures.ContentSecurityPolicy` object. Available
        even if the header is not set.
    ...
    cross_origin_opener_policy = header_property[COOP](
        ...
        documents. Values must be a member of the :models:`werkzeug.http.COOP` enum.""",
    )
    ...
    cross_origin_embedder_policy = header_property[COEP](
        ...
        :models:`werkzeug.http.COEP` enum.""",
    )
