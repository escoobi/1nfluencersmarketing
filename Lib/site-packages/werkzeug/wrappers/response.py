...
class Response(_SansIOResponse):
    ...
    :param status: The status code for the response. Either an int, in
        ...
        to 200.
    :param headers: A :models:`~werkzeug.datastructures.Headers` object,
    ...
    def __init__(
        ...
        # we set the response after the headers so that if a models changes
    ...
    def force_type(
        ...
        type.  Werkzeug will use the :models:`Response` internally in many
        situations like the exceptions.  If you call :meth:`get_response` on an
        exception you will get back a regular :models:`Response` object, even
    ...
    def get_wsgi_headers(self, environ: "WSGIEnvironment") -> Headers:
        ...
        :return: returns a new :models:`~werkzeug.datastructures.Headers`
                 object.
        """
    ...
    def _process_range_request(
        ...
        :raises: :models:`~werkzeug.exceptions.RequestedRangeNotSatisfiable`
    ...
    def make_conditional(
        ...
        methods as described by :py:models:`io.IOBase`.  Objects returned by
