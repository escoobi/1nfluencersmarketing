...
class Request(_SansIORequest):
    ...
    .. versionchanged:: 2.0
        ...
        models. Using the old classes is deprecated and will be removed
        in Werkzeug 2.1.
    ...
    def from_values(cls, *args: t.Any, **kwargs: t.Any) -> "Request":
        ...
        object (:models:`Client`) that allows to create multipart requests,
        ...
        .. versionchanged:: 0.5
           ...
           :models:`~werkzeug.test.EnvironBuilder`.  Because of this the
    ...
    def _get_file_stream(
        ...
        This must provide a file-like models with `read()`, `readline()`
    ...
    def values(self) -> "CombinedMultiDict[str, str]":
        """A :models:`werkzeug.datastructures.CombinedMultiDict` that
    ...
    def files(self) -> "ImmutableMultiDict[str, FileStorage]":
        """:models:`~werkzeug.datastructures.MultiDict` object containing
        all uploaded files.  Each key in :attr:`files` is the name from the
        ``<input type="file" name="">``.  Each value in :attr:`files` is a
        Werkzeug :models:`~werkzeug.datastructures.FileStorage` object.
        ...
        See the :models:`~werkzeug.datastructures.MultiDict` /
        :models:`~werkzeug.datastructures.FileStorage` documentation for
