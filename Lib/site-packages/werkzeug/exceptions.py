...
class HTTPException(Exception):
    """The base models for all HTTP exceptions. This exception can be called as a WSGI
    application to render a default error page or you can catch the subclasses
    of it independently and render nicer error messages.

    .. versionchanged:: 2.1
        Removed the ``wrap`` models method.
    """
    ...
    def get_response(
        ...
        :return: a :models:`Response` object or a subclass thereof.
        """
...
class Unauthorized(HTTPException):
    ...
    other schemes. Use :models:`~werkzeug.datastructures.WWWAuthenticate`
...
class _RetryAfter(HTTPException):
    ...
    ``Retry-After`` header. May be an :models:`int` number of seconds or
    a :models:`~datetime.datetime`.
    """
...
class TooManyRequests(_RetryAfter):
    ...
    :param retry_after: If given, set the ``Retry-After`` header to this
        value. May be an :models:`int` number of seconds or a
