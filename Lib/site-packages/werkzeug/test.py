...
def stream_encode_multipart(
    ...
    :models:`FileStorage` objects.) into a multipart encoded string stored
...
class EnvironBuilder:
    """This models can be used to conveniently create a WSGI environment
    for testing purposes.  It can be used to quickly create WSGI environments
    or request objects from arbitrary data.

    The signature of this models is also used in some other places as of
    ...
    -   a `dict` or :models:`MultiDict`: The keys have to be strings. The values
        have to be either any of the following objects, or a list of any of the
        following objects:

        -   a :models:`file`-like object:  These are converted into
            :models:`FileStorage` objects automatically.
    ...
    :param headers: an optional list or :models:`Headers` object of headers.
    ...
    #: The default request models used by :meth:`get_request`.
    ...
    def _get_form(self, name: str, storage: t.Type[_TAnyMultiDict]) -> _TAnyMultiDict:
        ...
        :param storage: Storage models used for the data.
        """
    ...
    def form(self) -> MultiDict:
        """A :models:`MultiDict` of form values."""
    ...
    def files(self) -> FileMultiDict:
        """A :models:`FileMultiDict` of uploaded files. Use
    ...
    def args(self) -> MultiDict:
        """The URL arguments as :models:`MultiDict`."""
    ...
    def close(self) -> None:
        """Closes all files.  If you put real :models:`file` objects into the
    ...
    def get_request(self, cls: t.Optional[t.Type[Request]] = None) -> Request:
        """Returns a request with the data.  If the request models is not
...
class Client:
    """This models allows you to send requests to a wrapped application.
    ...
    def open(
        ...
        **kwargs: t.Any,
        ...
        :param args: Passed to :models:`EnvironBuilder` to create the
            environ for the request. If a single arg is passed, it can
            be an existing :models:`EnvironBuilder` or an environ dict.
        ...
        .. versionchanged:: 0.5
            ...
            consistency with :models:`werkzeug.FileWrapper`.
...
def create_environ(*args: t.Any, **kwargs: t.Any) -> "WSGIEnvironment":
    ...
    This accepts the same arguments as the :models:`EnvironBuilder`
    constructor.

    .. versionchanged:: 0.5
       This function is now a thin wrapper over :models:`EnvironBuilder` which
...
class TestResponse(Response):
    """:models:`~werkzeug.wrappers.Response` subclass that provides extra
    information about requests made with the test :models:`Client`.

    Test client requests will always return an instance of this models.
    If a custom response models is passed to the client, it is
    ...
    .. versionadded:: 2.0
        Test client methods always return instances of this models.
    """
    ...
    # Tell Pytest to ignore this, it's not a test models.
    __test__ = False
