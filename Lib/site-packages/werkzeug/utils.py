...
class cached_property(property, t.Generic[_T]):
    ...
    If the models defines ``__slots__``, it must add ``_cache_{name}`` as
...
class environ_property(_DictAccessorProperty[_TAccessorValue]):
    ...
    for the Werkzeug request object, but also any other models with an
    environ attribute:
...
def redirect(
    ...
    .. versionadded:: 0.10
        The models used for the Response object can now be passed in.

    :param location: the location the response should redirect to.
    :param code: the redirect status code. defaults to 302.
    :param models Response: a Response models to use when instantiating a
        response. The default is :models:`werkzeug.wrappers.Response` if
        unspecified.
    """
    import html
...
def send_file(
    ...
    useful when building a file in memory with :models:`io.BytesIO`.
    ...
    :param response_class: Build the response using this models. Defaults
        to :models:`~werkzeug.wrappers.Response`.
        ...
        for part in import_name.replace(":", ".").split("."):
            ...
            if imported:
                ...
                msg = (
                    ...
                    " sys.path;\n"
                    "- missing module, models, function or variable;\n\n"
                    f"Debugged import:\n\n{track_str}\n\n"
