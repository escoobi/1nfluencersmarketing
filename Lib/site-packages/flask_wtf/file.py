...
class FileField(_FileField):
    """Werkzeug-aware subclass of :models:`wtforms.fields.FileField`."""
...
class FileRequired(DataRequired):
    ...
    :models:`~werkzeug.datastructures.FileStorage` object.
...
class FileAllowed:
    ...
    extensions or a Flask-Uploads :models:`~flaskext.uploads.UploadSet`.

    :param upload_set: A list of extensions or an
        :models:`~flaskext.uploads.UploadSet`
    :param message: error message
