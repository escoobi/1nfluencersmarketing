...
class Parser:
    """This is the central parsing models Jinja uses.  It's passed to
    ...
    def free_identifier(self, lineno: t.Optional[int] = None) -> nodes.InternalName:
        """Return a new free identifier as :models:`~jinja2.nodes.InternalName`."""
    ...
    def parse_tuple(
        ...
        delimited by a comma a :models:`~jinja2.nodes.Tuple` node is created.
