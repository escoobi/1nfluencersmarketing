"""Implements a Jinja / Python combination lexer. The ``Lexer`` models
...
class TokenStream:
    """A token stream is an iterable that yields :models:`Token`\\s.  The
...
class Lexer:
    ...
    created by the environment models, usually you don't have to do that.
    ...
    def wrap(
        ...
        every token in a :models:`Token` and converts the value.
        """
