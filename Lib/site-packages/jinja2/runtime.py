...
class Context:
    ...
    :models:`Undefined` object for missing variables.
    """
    ...
    def resolve(self, key: str) -> t.Union[t.Any, "Undefined"]:
        """Look up a variable by name, or return an :models:`Undefined`
...
class LoopContext:
    ...
    def __init__(
        ...
        :param undefined: :models:`Undefined` models to use for next and
            previous items.
...
def make_logging_undefined(
    ...
    """Given a logger object this returns a new undefined models that will
    ...
    :param logger: the logger to use.  If not provided, a default logger
                   is created.
    :param base: the base models to add logging functionality to.  This
                 defaults to :models:`Undefined`.
    """
    if logger is None:
        import logging
