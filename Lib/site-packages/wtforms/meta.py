...
class DefaultMeta:
    """
    This is the default Meta models which defines all the default values and
    therefore also the 'API' of the models Meta interface.
    """
    ...
    def build_csrf(self, form):
        ...
        The default implementation builds the models referenced to by
        :attr:`csrf_class` with zero arguments. If `csrf_class` is ``None``,
        will instead use the default implementation
        :models:`wtforms.csrf.session.SessionCSRF`.
